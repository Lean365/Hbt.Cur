...
public class HbtDbSeedWorkflowDictData
{
    ...
    public HbtDbSeedWorkflowDictData(IHbtRepository<HbtDictData> dictDataRepository, IHbtLogger logger)
    {
    ...
    /// 初始化工作流字典数据
    /// </summary>
    public async Task<(int, int)> InitializeWorkflowDictDataAsync()
    {
        int insertCount = 0;
        int updateCount = 0;
        ...
        var defaultDictData = new List<HbtDictData>
        {
            ...
            // 活动类型
            new HbtDictData { DictType = "workflow_activity_type", DictLabel = "开始活动", DictValue = "start",CssClass=1,ListClass=1, OrderNum = 1, Status = 0, Remark = "工作流开始节点" },
            new HbtDictData { DictType = "workflow_activity_type", DictLabel = "结束活动", DictValue = "end",CssClass=2,ListClass=2, OrderNum = 2, Status = 0, Remark = "工作流结束节点" },
            new HbtDictData { DictType = "workflow_activity_type", DictLabel = "审批活动", DictValue = "approval",CssClass=3,ListClass=3, OrderNum = 3, Status = 0, Remark = "工作流审批节点" },
            new HbtDictData { DictType = "workflow_activity_type", DictLabel = "分支活动", DictValue = "branch",CssClass=4,ListClass=4, OrderNum = 4, Status = 0, Remark = "工作流分支节点" },
            new HbtDictData { DictType = "workflow_activity_type", DictLabel = "合并活动", DictValue = "merge",CssClass=5,ListClass=5, OrderNum = 5, Status = 0, Remark = "工作流合并节点" },
            new HbtDictData { DictType = "workflow_activity_type", DictLabel = "服务活动", DictValue = "service",CssClass=6,ListClass=6, OrderNum = 6, Status = 0, Remark = "工作流服务节点" },
            ...
            // 流程状态
            new HbtDictData { DictType = "workflow_status", DictLabel = "草稿", DictValue = "draft",CssClass=1,ListClass=1, OrderNum = 1, Status = 0, Remark = "流程草稿状态" },
            new HbtDictData { DictType = "workflow_status", DictLabel = "运行中", DictValue = "running",CssClass=2,ListClass=2, OrderNum = 2, Status = 0, Remark = "流程运行状态" },
            new HbtDictData { DictType = "workflow_status", DictLabel = "已完成", DictValue = "completed",CssClass=3,ListClass=3, OrderNum = 3, Status = 0, Remark = "流程完成状态" },
            new HbtDictData { DictType = "workflow_status", DictLabel = "已终止", DictValue = "terminated",CssClass=4,ListClass=4, OrderNum = 4, Status = 0, Remark = "流程终止状态" },
            new HbtDictData { DictType = "workflow_status", DictLabel = "已挂起", DictValue = "suspended",CssClass=5,ListClass=5, OrderNum = 5, Status = 0, Remark = "流程挂起状态" },

            // 实例状态
            new HbtDictData { DictType = "workflow_instance_status", DictLabel = "运行中", DictValue = "running",CssClass=1,ListClass=1, OrderNum = 1, Status = 0, Remark = "实例运行状态" },
            new HbtDictData { DictType = "workflow_instance_status", DictLabel = "已完成", DictValue = "completed",CssClass=2,ListClass=2, OrderNum = 2, Status = 0, Remark = "实例完成状态" },
            new HbtDictData { DictType = "workflow_instance_status", DictLabel = "已终止", DictValue = "terminated",CssClass=3,ListClass=3, OrderNum = 3, Status = 0, Remark = "实例终止状态" },
            new HbtDictData { DictType = "workflow_instance_status", DictLabel = "已挂起", DictValue = "suspended",CssClass=4,ListClass=4, OrderNum = 4, Status = 0, Remark = "实例挂起状态" },

            // 节点类型
            new HbtDictData { DictType = "workflow_node_type", DictLabel = "开始节点", DictValue = "start",CssClass=1,ListClass=1, OrderNum = 1, Status = 0, Remark = "流程开始节点" },
            new HbtDictData { DictType = "workflow_node_type", DictLabel = "结束节点", DictValue = "end",CssClass=2,ListClass=2, OrderNum = 2, Status = 0, Remark = "流程结束节点" },
            new HbtDictData { DictType = "workflow_node_type", DictLabel = "审批节点", DictValue = "approval",CssClass=3,ListClass=3, OrderNum = 3, Status = 0, Remark = "流程审批节点" },
            new HbtDictData { DictType = "workflow_node_type", DictLabel = "分支节点", DictValue = "branch",CssClass=4,ListClass=4, OrderNum = 4, Status = 0, Remark = "流程分支节点" },
            new HbtDictData { DictType = "workflow_node_type", DictLabel = "合并节点", DictValue = "merge",CssClass=5,ListClass=5, OrderNum = 5, Status = 0, Remark = "流程合并节点" },
            new HbtDictData { DictType = "workflow_node_type", DictLabel = "服务节点", DictValue = "service",CssClass=6,ListClass=6, OrderNum = 6, Status = 0, Remark = "流程服务节点" },

            // 节点状态
            new HbtDictData { DictType = "workflow_node_status", DictLabel = "草稿", DictValue = "draft",CssClass=1,ListClass=1, OrderNum = 1, Status = 0, Remark = "节点草稿状态" },
            new HbtDictData { DictType = "workflow_node_status", DictLabel = "运行中", DictValue = "running",CssClass=2,ListClass=2, OrderNum = 2, Status = 0, Remark = "节点运行状态" },
            new HbtDictData { DictType = "workflow_node_status", DictLabel = "已完成", DictValue = "completed",CssClass=3,ListClass=3, OrderNum = 3, Status = 0, Remark = "节点完成状态" },
            new HbtDictData { DictType = "workflow_node_status", DictLabel = "已终止", DictValue = "terminated",CssClass=4,ListClass=4, OrderNum = 4, Status = 0, Remark = "节点终止状态" },
            new HbtDictData { DictType = "workflow_node_status", DictLabel = "已挂起", DictValue = "suspended",CssClass=5,ListClass=5, OrderNum = 5, Status = 0, Remark = "节点挂起状态" },

            // 任务类型
            new HbtDictData { DictType = "workflow_task_type", DictLabel = "审批任务", DictValue = "approval",CssClass=1,ListClass=1, OrderNum = 1, Status = 0, Remark = "审批类型任务" },
            new HbtDictData { DictType = "workflow_task_type", DictLabel = "会签任务", DictValue = "countersign",CssClass=2,ListClass=2, OrderNum = 2, Status = 0, Remark = "会签类型任务" },
            new HbtDictData { DictType = "workflow_task_type", DictLabel = "加签任务", DictValue = "addsign",CssClass=3,ListClass=3, OrderNum = 3, Status = 0, Remark = "加签类型任务" },
            new HbtDictData { DictType = "workflow_task_type", DictLabel = "转办任务", DictValue = "transfer",CssClass=4,ListClass=4, OrderNum = 4, Status = 0, Remark = "转办类型任务" },

            // 任务状态
            new HbtDictData { DictType = "workflow_task_status", DictLabel = "待处理", DictValue = "pending",CssClass=1,ListClass=1, OrderNum = 1, Status = 0, Remark = "任务待处理状态" },
            new HbtDictData { DictType = "workflow_task_status", DictLabel = "处理中", DictValue = "processing",CssClass=2,ListClass=2, OrderNum = 2, Status = 0, Remark = "任务处理中状态" },
            new HbtDictData { DictType = "workflow_task_status", DictLabel = "已完成", DictValue = "completed",CssClass=3,ListClass=3, OrderNum = 3, Status = 0, Remark = "任务完成状态" },
            new HbtDictData { DictType = "workflow_task_status", DictLabel = "已拒绝", DictValue = "rejected",CssClass=4,ListClass=4, OrderNum = 4, Status = 0, Remark = "任务拒绝状态" },
            new HbtDictData { DictType = "workflow_task_status", DictLabel = "已转办", DictValue = "transferred",CssClass=5,ListClass=5, OrderNum = 5, Status = 0, Remark = "任务转办状态" },
            new HbtDictData { DictType = "workflow_task_status", DictLabel = "已取消", DictValue = "cancelled",CssClass=6,ListClass=6, OrderNum = 6, Status = 0, Remark = "任务取消状态" },

            // 优先级
            new HbtDictData { DictType = "workflow_priority", DictLabel = "普通", DictValue = "normal",CssClass=1,ListClass=1, OrderNum = 1, Status = 0, Remark = "普通优先级" },
            new HbtDictData { DictType = "workflow_priority", DictLabel = "重要", DictValue = "important",CssClass=2,ListClass=2, OrderNum = 2, Status = 0, Remark = "重要优先级" },
            new HbtDictData { DictType = "workflow_priority", DictLabel = "紧急", DictValue = "urgent",CssClass=3,ListClass=3, OrderNum = 3, Status = 0, Remark = "紧急优先级" },
            new HbtDictData { DictType = "workflow_priority", DictLabel = "特急", DictValue = "critical",CssClass=4,ListClass=4, OrderNum = 4, Status = 0, Remark = "特急优先级" },
        ...
        {
            var existingDictData = await _dictDataRepository.GetFirstAsync(d => 
                d.DictType == dictData.DictType && d.DictValue == dictData.DictValue);
            ...
            if (existingDictData == null)
            {
                ...
                insertCount++;
                _logger.Info($"已添加工作流字典数据: {dictData.DictLabel}");
            }
            else
            {
                ...
                updateCount++;
                _logger.Info($"已更新工作流字典数据: {dictData.DictLabel}");
            }
        }
