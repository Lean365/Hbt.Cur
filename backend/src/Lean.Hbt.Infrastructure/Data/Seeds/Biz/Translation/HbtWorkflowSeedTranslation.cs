...
public class HbtWorkflowSeedTranslation
{
    ...
    public List<HbtTranslation> GetWorkflowTranslations()
    {
        return new List<HbtTranslation>
        {
            ...
            // 工作流定义相关
            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.NotFound", TransValue = "工作流定义不存在", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.NotFound", TransValue = "Workflow definition not found", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.NotFound", TransValue = "ワークフロー定義が存在しません", ModuleName = "Workflow", Status = 0 },

            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.NameExists", TransValue = "工作流定义名称已存在", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.NameExists", TransValue = "Workflow definition name already exists", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.NameExists", TransValue = "ワークフロー定義名が既に存在します", ModuleName = "Workflow", Status = 0 },

            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.Create.Failed", TransValue = "创建工作流定义失败", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.Create.Failed", TransValue = "Failed to create workflow definition", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.Create.Failed", TransValue = "ワークフロー定義の作成に失敗しました", ModuleName = "Workflow", Status = 0 },

            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.Update.Failed", TransValue = "更新工作流定义失败", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.Update.Failed", TransValue = "Failed to update workflow definition", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.Update.Failed", TransValue = "ワークフロー定義の更新に失敗しました", ModuleName = "Workflow", Status = 0 },

            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.Delete.Failed", TransValue = "删除工作流定义失败", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.Delete.Failed", TransValue = "Failed to delete workflow definition", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.Delete.Failed", TransValue = "ワークフロー定義の削除に失敗しました", ModuleName = "Workflow", Status = 0 },

            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.CannotDeleteActive", TransValue = "无法删除已发布的工作流定义", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.CannotDeleteActive", TransValue = "Cannot delete published workflow definition", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.CannotDeleteActive", TransValue = "公開済みのワークフロー定義は削除できません", ModuleName = "Workflow", Status = 0 },

            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.BatchDelete.Failed", TransValue = "批量删除工作流定义失败", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.BatchDelete.Failed", TransValue = "Failed to batch delete workflow definitions", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.BatchDelete.Failed", TransValue = "ワークフロー定義の一括削除に失敗しました", ModuleName = "Workflow", Status = 0 },

            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.UpdateStatus.Failed", TransValue = "更新工作流定义状态失败", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.UpdateStatus.Failed", TransValue = "Failed to update workflow definition status", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.UpdateStatus.Failed", TransValue = "ワークフロー定義の状態更新に失敗しました", ModuleName = "Workflow", Status = 0 },

            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.UpgradeVersion.Failed", TransValue = "升级工作流定义版本失败", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.UpgradeVersion.Failed", TransValue = "Failed to upgrade workflow definition version", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.UpgradeVersion.Failed", TransValue = "ワークフロー定義のバージョンアップグレードに失敗しました", ModuleName = "Workflow", Status = 0 },

            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.GetOptions.Success", TransValue = "获取工作流定义选项成功，共{0}条", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.GetOptions.Success", TransValue = "Successfully retrieved {0} workflow definition options", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.GetOptions.Success", TransValue = "ワークフロー定義オプションの取得に成功しました。{0}件", ModuleName = "Workflow", Status = 0 },

            new HbtTranslation { LangCode = "zh-CN", TransKey = "WorkflowDefinition.GetOptions.Failed", TransValue = "获取工作流定义选项失败", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "WorkflowDefinition.GetOptions.Failed", TransValue = "Failed to get workflow definition options", ModuleName = "Workflow", Status = 0 },
            new HbtTranslation { LangCode = "ja-JP", TransKey = "WorkflowDefinition.GetOptions.Failed", TransValue = "ワークフロー定義オプションの取得に失敗しました", ModuleName = "Workflow", Status = 0 }
        };
    }
}