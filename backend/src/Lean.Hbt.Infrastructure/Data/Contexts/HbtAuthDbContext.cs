...
namespace Lean.Hbt.Infrastructure.Data.Contexts
{
    ...
    /// </summary>
    public class HbtAuthDbContext : IHbtAuthDbContext
    {
        /// <summary>
        /// SqlSugar数据库客户端实例
        /// </summary>
        ...
        public HbtAuthDbContext(string connectionString, IOptions<HbtDbOptions> dbOptions, IHbtLogger logger, IHbtCurrentUser currentUser, IServiceProvider serviceProvider, IConfiguration configuration)
        {
            _logger = logger;
...
/// 认证数据库上下文接口
/// </summary>
public interface IHbtAuthDbContext
{
    /// <summary>
    /// 获取数据库客户端实例
    /// </summary>
