...
namespace Lean.Hbt.Infrastructure.SignalR.Cache
{
    ...
    /// </remarks>
    public class HbtSignalRRedisCache : IHbtSignalRCacheService
    {
        /// <summary>
        /// Redis缓存服务实例
        /// </summary>
        ...
        public HbtSignalRRedisCache(IHbtRedisCache cache)
        {
            _cache = cache;
        }
        ...
        {
            return await _cache.GetAsync<HbtOnlineUser>(key);
        }
        ...
        public async Task<List<HbtOnlineUser>> GetOnlineUsersAsync()
        {
            ...
            {
                if (await _cache.GetAsync<HbtOnlineUser>(key) is HbtOnlineUser user)
                {
                    users.Add(user);
                }
            }
