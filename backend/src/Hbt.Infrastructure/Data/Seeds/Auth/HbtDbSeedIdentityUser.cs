...
/// 用户数据初始化类
/// </summary>
public class HbtDbSeedIdentityUser
{
    ...
    public async Task<(int, int)> InitializeSystemUsersAsync()
    {
        ...
        var systemUserNames = new[] { "admin", "developer", "tester", "user", "demo" };
        var existingUsers = await UserRepository.GetListAsync(u => systemUserNames.Contains(u.UserName));
        ...
        var db = UserRepository.SqlSugarClient;
        ...
        var systemUsers = new List<HbtUser>
        {
            ...
            new HbtUser { UserName = "developer", NickName = "开发工程师",RealName = "开发工程师",FullName = "开发工程师",EnglishName = "Developer", UserType = 1, Email = "developer@lean.com", PhoneNumber = "13800000002", Gender = 0, Avatar = "/avatar/default.gif", Status = 0, LastPasswordChangeTime = now, IsLock = 0, ErrorLimit = 0, LoginCount = 0 },
            new HbtUser { UserName = "tester", NickName = "测试工程师",RealName = "测试工程师",FullName = "测试工程师",EnglishName = "Test Engineer", UserType = 1, Email = "tester@lean.com", PhoneNumber = "13800000003", Gender = 0, Avatar = "/avatar/default.gif", Status = 0, LastPasswordChangeTime = now, IsLock = 0, ErrorLimit = 0, LoginCount = 0 },
            new HbtUser { UserName = "user", NickName = "普通用户",RealName = "普通用户",FullName = "普通用户",EnglishName = "Normal User", UserType = 1, Email = "user@lean.com", PhoneNumber = "13800000004", Gender = 0, Avatar = "/avatar/default.gif", Status = 0, LastPasswordChangeTime = now, IsLock = 0, ErrorLimit = 0, LoginCount = 0 },
            new HbtUser { UserName = "demo", NickName = "演示用户",RealName = "演示用户",FullName = "演示用户",EnglishName = "Demo User", UserType = 1, Email = "demo@lean.com", PhoneNumber = "13800000005", Gender = 0, Avatar = "/avatar/default.gif", Status = 0, LastPasswordChangeTime = now, IsLock = 0, ErrorLimit = 0, LoginCount = 0 }
        };
    ...
    public async Task<(int, int)> InitializeBatchUsersAsync(int totalCount = 10)
    {
        ...
        // 获取所有已存在的用户
        var existingUsers = await UserRepository.GetListAsync(u => u.UserName.StartsWith("hbt"));
        var existingUserDict = existingUsers.ToDictionary(u => u.UserName, u => u);
        var existingPhones = existingUsers.Select(u => u.PhoneNumber).ToHashSet();
