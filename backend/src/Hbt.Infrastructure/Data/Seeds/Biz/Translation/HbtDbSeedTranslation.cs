...
public class HbtDbSeedTranslation
{
    ...
    public List<HbtTranslation> GetDefaultTranslations()
    {
        ...
        {
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.OperationSuccess", TransValue = "操作成功", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.OperationFailed", TransValue = "操作失败", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.SaveSuccess", TransValue = "保存成功", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.SaveFailed", TransValue = "保存失败", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.DeleteSuccess", TransValue = "删除成功", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.DeleteFailed", TransValue = "删除失败", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.UpdateSuccess", TransValue = "更新成功", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.UpdateFailed", TransValue = "更新失败", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.QuerySuccess", TransValue = "查询成功", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.QueryFailed", TransValue = "查询失败", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.SubmitSuccess", TransValue = "提交成功", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.SubmitFailed", TransValue = "提交失败", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.InvalidRequest", TransValue = "无效的请求", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.DataNotFound", TransValue = "数据不存在", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.DataExists", TransValue = "数据已存在", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "zh-CN", TransKey = "Common.ServerError", TransValue = "服务器错误", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.OperationSuccess", TransValue = "Operation successful", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.OperationFailed", TransValue = "Operation failed", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.SaveSuccess", TransValue = "Save successful", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.SaveFailed", TransValue = "Save failed", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.DeleteSuccess", TransValue = "Delete successful", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.DeleteFailed", TransValue = "Delete failed", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.UpdateSuccess", TransValue = "Update successful", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.UpdateFailed", TransValue = "Update failed", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.QuerySuccess", TransValue = "Query successful", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.QueryFailed", TransValue = "Query failed", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.SubmitSuccess", TransValue = "Submit successful", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.SubmitFailed", TransValue = "Submit failed", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.InvalidRequest", TransValue = "Invalid request", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.DataNotFound", TransValue = "Data not found", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.DataExists", TransValue = "Data already exists", ModuleName = "Backend", Status = 0 },
            new HbtTranslation { LangCode = "en-US", TransKey = "Common.ServerError", TransValue = "Server error", ModuleName = "Backend", Status = 0 },
