...
namespace Lean.Hbt.Application.Dtos.Human.Performance
{
    /// <summary>
    /// 绩效基础DTO
    /// </summary>
    public class HbtPerformanceDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPerformanceDto()
        {
    ...
    /// 绩效查询DTO
    /// </summary>
    public class HbtPerformanceQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPerformanceQueryDto()
        {
            PerformanceType = string.Empty;
            Evaluator = string.Empty;
            Comment = string.Empty;
    ...
    /// 绩效创建DTO
    /// </summary>
    public class HbtPerformanceCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPerformanceCreateDto()
        {
            PerformanceType = string.Empty;
            Evaluator = string.Empty;
            Comment = string.Empty;
    ...
    /// 绩效更新DTO
    /// </summary>
    public class HbtPerformanceUpdateDto : HbtPerformanceCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPerformanceUpdateDto() : base()
        {
        }
    ...
    /// 绩效删除DTO
    /// </summary>
    public class HbtPerformanceDeleteDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPerformanceDeleteDto()
        {
            Remark = string.Empty;
        }
    ...
    /// 绩效导入DTO
    /// </summary>
    public class HbtPerformanceImportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPerformanceImportDto()
        {
    ...
    /// 绩效导出DTO
    /// </summary>
    public class HbtPerformanceExportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPerformanceExportDto()
        {
            EmployeeNo = string.Empty;
    ...
    /// 绩效模板DTO
    /// </summary>
    public class HbtPerformanceTemplateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPerformanceTemplateDto()
        {
            EmployeeNo = string.Empty;
            PerformanceType = string.Empty;
            PeriodStart = string.Empty;
