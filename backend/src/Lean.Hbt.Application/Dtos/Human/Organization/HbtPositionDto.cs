...
namespace Lean.Hbt.Application.Dtos.Human.Organization
{
    /// <summary>
    /// 职位基础DTO
    /// </summary>
    public class HbtPositionDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPositionDto()
        {
    ...
    /// 职位查询DTO
    /// </summary>
    public class HbtPositionQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPositionQueryDto()
        {
            PosCode = string.Empty;
            PosName = string.Empty;
            EnglishName = string.Empty;
    ...
    /// 职位创建DTO
    /// </summary>
    public class HbtPositionCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPositionCreateDto()
        {
            PosCode = string.Empty;
            PosName = string.Empty;
            EnglishName = string.Empty;
    ...
    /// 职位更新DTO
    /// </summary>
    public class HbtPositionUpdateDto : HbtPositionCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPositionUpdateDto() : base()
        {
        }
    ...
    /// 职位删除DTO
    /// </summary>
    public class HbtPositionDeleteDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPositionDeleteDto()
        {
            Remark = string.Empty;
        }
    ...
    /// 职位导入DTO
    /// </summary>
    public class HbtPositionImportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPositionImportDto()
        {
            PosCode = string.Empty;
            PosName = string.Empty;
            EnglishName = string.Empty;
    ...
    /// 职位导出DTO
    /// </summary>
    public class HbtPositionExportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPositionExportDto()
        {
            PosCode = string.Empty;
            PosName = string.Empty;
            EnglishName = string.Empty;
    ...
    /// 职位模板DTO
    /// </summary>
    public class HbtPositionTemplateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtPositionTemplateDto()
        {
            PosCode = string.Empty;
            PosName = string.Empty;
            EnglishName = string.Empty;
