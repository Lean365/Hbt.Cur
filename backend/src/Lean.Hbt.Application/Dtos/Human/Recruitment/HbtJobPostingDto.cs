// -----------------------------------------------------------------------------
// <copyright file="HbtJobPostingDto.cs" company="Hbt365">
...
namespace Lean.Hbt.Application.Dtos.Human.Recruitment;

/// <summary>
/// 职位发布基础 DTO
/// </summary>
public class HbtJobPostingDto
{
    /// <summary>
    /// 主键ID
    /// </summary>
    ...
    /// 招聘负责人
    /// </summary>
    public Employee.HbtEmployeeDto? Recruiter { get; set; }
}

/// <summary>
/// 职位发布查询 DTO
/// </summary>
public class HbtJobPostingQueryDto : HbtPagedQuery
{
    /// <summary>
    /// 发布编号
    /// </summary>
...
/// 职位发布创建 DTO
/// </summary>
public class HbtJobPostingCreateDto
{
    /// <summary>
    /// 公司代码
    /// </summary>
...
/// 职位发布更新 DTO
/// </summary>
public class HbtJobPostingUpdateDto
{
    /// <summary>
    /// 主键ID
    /// </summary>
...
/// 职位发布删除 DTO
/// </summary>
public class HbtJobPostingDeleteDto
{
    /// <summary>
    /// 主键ID列表
    /// </summary>
...
/// 职位发布导入 DTO
/// </summary>
public class HbtJobPostingImportDto
{
    /// <summary>
    /// 公司代码
    /// </summary>
...
/// 职位发布导出 DTO
/// </summary>
public class HbtJobPostingExportDto
{
    /// <summary>
    /// 主键ID
    /// </summary>
...
/// 职位发布模板 DTO
/// </summary>
public class HbtJobPostingTemplateDto
{
    /// <summary>
    /// 公司代码
    /// </summary>
