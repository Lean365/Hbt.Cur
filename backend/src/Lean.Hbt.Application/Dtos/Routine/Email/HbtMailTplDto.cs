...
namespace Lean.Hbt.Application.Dtos.Routine.Email
{
    /// <summary>
    /// 邮件模板基础DTO
    /// </summary>
    public class HbtMailTplDto
    {
        ...
        /// </summary>
        [AdaptMember("Id")]
        public long EmailTplId { get; set; }
    ...
    /// 邮件模板删除DTO
    /// </summary>
    public class HbtMailTplDeleteDto
    {
    ...
    /// 邮件模板批量删除DTO
    /// </summary>
    public class HbtMailTplBatchDeleteDto
    {
        /// <summary>主键ID列表</summary>
        public List<long> EmailTplIds { get; set; } = new List<long>();
    }
