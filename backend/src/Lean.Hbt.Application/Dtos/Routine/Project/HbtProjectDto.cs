...
namespace Lean.Hbt.Application.Dtos.Routine.Project
{
    /// <summary>
    /// 项目基础DTO
    /// </summary>
    public class HbtProjectDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtProjectDto()
        {
    ...
    /// 项目查询DTO
    /// </summary>
    public class HbtProjectQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtProjectQueryDto()
        {
            ProjectCode = string.Empty;
            ProjectName = string.Empty;
            ProjectCategory = string.Empty;
    ...
    /// 项目创建DTO
    /// </summary>
    public class HbtProjectCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtProjectCreateDto()
        {
            CompanyCode = string.Empty;
            ProjectCode = string.Empty;
            ProjectName = string.Empty;
    ...
    /// 项目更新DTO
    /// </summary>
    public class HbtProjectUpdateDto : HbtProjectCreateDto
    {
        /// <summary>
        /// ID
        /// </summary>
    ...
    /// 项目删除DTO
    /// </summary>
    public class HbtProjectDeleteDto
    {
    ...
    /// 项目批量删除DTO
    /// </summary>
    public class HbtProjectBatchDeleteDto
    {
    ...
    /// 项目导入DTO
    /// </summary>
    public class HbtProjectImportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtProjectImportDto()
        {
            CompanyCode = string.Empty;
            ProjectCode = string.Empty;
            ProjectName = string.Empty;
    ...
    /// 项目导出DTO
    /// </summary>
    public class HbtProjectExportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtProjectExportDto()
        {
            CompanyCode = string.Empty;
            ProjectCode = string.Empty;
            ProjectName = string.Empty;
    ...
    /// 项目导入模板DTO
    /// </summary>
    public class HbtProjectTemplateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtProjectTemplateDto()
        {
            CompanyCode = string.Empty;
            ProjectCode = string.Empty;
            ProjectName = string.Empty;
