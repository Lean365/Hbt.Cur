...
namespace Lean.Hbt.Application.Dtos.Routine.Document.Iso
{
    /// <summary>
    /// ISO文档基础DTO
    /// </summary>
    public class HbtIsoDocumentDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtIsoDocumentDto()
        {
        ...
        /// <summary>节点类型(1=集团 2=分公司 3=部门 4=科室 5=班组 6=文档)</summary>
        public int NodeType { get; set; } = 6;
        ...
        /// <summary>文档类型(1=质量手册 2=程序文件 3=作业指导书 4=记录表格 5=其他)</summary>
        public int DocumentType { get; set; } = 1;

        /// <summary>文档级别(1=一级 2=二级 3=三级 4=四级)</summary>
        ...
        public HbtIsoDocumentDto? Parent { get; set; }

        /// <summary>子级文档列表</summary>
        public List<HbtIsoDocumentDto>? Children { get; set; }
    }

    /// <summary>
    /// ISO文档查询DTO
    /// </summary>
    public class HbtIsoDocumentQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtIsoDocumentQueryDto()
        {
            DocumentCode = string.Empty;
            DocumentName = string.Empty;
            DocumentTitle = string.Empty;
    ...
    /// ISO文档创建DTO
    /// </summary>
    public class HbtIsoDocumentCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtIsoDocumentCreateDto()
        {
            DocumentCode = string.Empty;
            DocumentName = string.Empty;
            DocumentTitle = string.Empty;
    ...
    /// ISO文档更新DTO
    /// </summary>
    public class HbtIsoDocumentUpdateDto : HbtIsoDocumentCreateDto
    {
    ...
    /// ISO文档导入DTO
    /// </summary>
    public class HbtIsoDocumentImportDto
    {
        /// <summary>文档编号</summary>
    ...
    /// ISO文档导出DTO
    /// </summary>
    public class HbtIsoDocumentExportDto
    {
        /// <summary>文档编号</summary>
        public string DocumentCode { get; set; } = string.Empty;
    ...
    /// ISO文档模板DTO
    /// </summary>
    public class HbtIsoDocumentTemplateDto
    {
        /// <summary>文档编号</summary>
        public string DocumentCode { get; set; } = string.Empty;
