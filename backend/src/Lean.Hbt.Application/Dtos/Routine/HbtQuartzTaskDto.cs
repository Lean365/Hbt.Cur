...
namespace Lean.Hbt.Application.Dtos.Routine
{
    ...
    /// 定时任务基础DTO
    /// </summary>
    public class HbtQuartzTaskDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtQuartzTaskDto()
        {
    ...
    /// 定时任务查询DTO
    /// </summary>
    public class HbtQuartzTaskQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtQuartzTaskQueryDto()
        {
            TaskName = string.Empty;
            TaskGroupName = string.Empty;
        }
    ...
    /// 定时任务创建DTO
    /// </summary>
    public class HbtQuartzTaskCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtQuartzTaskCreateDto()
        {
            TaskName = string.Empty;
            TaskGroupName = string.Empty;
            TaskAssemblyName = string.Empty;
    ...
    /// 定时任务更新DTO
    /// </summary>
    public class HbtQuartzTaskUpdateDto : HbtQuartzTaskCreateDto
    {
        /// <summary>
        /// ID
        /// </summary>
    ...
    /// 定时任务导入DTO
    /// </summary>
    public class HbtQuartzTaskImportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtQuartzTaskImportDto()
        {
            TaskName = string.Empty;
            TaskGroupName = string.Empty;
            TaskAssemblyName = string.Empty;
        ...
        /// 触发器类型（0简单 1Cron）
        /// </summary>
        public string TaskTriggerType { get; set; }
        ...
        /// 是否并发执行
        /// </summary>
        public string TaskConcurrent { get; set; }
    ...
    /// 定时任务导出DTO
    /// </summary>
    public class HbtQuartzTaskExportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtQuartzTaskExportDto()
        {
            TaskName = string.Empty;
            TaskGroupName = string.Empty;
            TaskAssemblyName = string.Empty;
    ...
    /// 定时任务导入模板DTO
    /// </summary>
    public class HbtQuartzTaskTemplateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtQuartzTaskTemplateDto()
        {
            TaskName = string.Empty;
            TaskGroupName = string.Empty;
            TaskAssemblyName = string.Empty;
