...
namespace Lean.Hbt.Application.Dtos.Routine
{
    ...
    /// 邮件模板基础DTO
    /// </summary>
    public class HbtMailTmplDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtMailTmplDto()
        {
    ...
    /// 邮件模板查询DTO
    /// </summary>
    public class HbtMailTmplQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtMailTmplQueryDto()
        {
            TmplName = string.Empty;
            TmplCode = string.Empty;
        }
    ...
    /// 邮件模板创建DTO
    /// </summary>
    public class HbtMailTmplCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtMailTmplCreateDto()
        {
            TmplName = string.Empty;
            TmplCode = string.Empty;
            TmplSubject = string.Empty;
    ...
    /// 邮件模板更新DTO
    /// </summary>
    public class HbtMailTmplUpdateDto : HbtMailTmplCreateDto
    {
        /// <summary>
        /// ID
        /// </summary>
    ...
    /// 邮件模板导入DTO
    /// </summary>
    public class HbtMailTmplImportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtMailTmplImportDto()
        {
            TmplName = string.Empty;
            TmplCode = string.Empty;
            TmplSubject = string.Empty;
    ...
    /// 邮件模板导出DTO
    /// </summary>
    public class HbtMailTmplExportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtMailTmplExportDto()
        {
            TmplName = string.Empty;
            TmplCode = string.Empty;
            TmplSubject = string.Empty;
    ...
    /// 邮件模板导入模板DTO
    /// </summary>
    public class HbtMailTmplTemplateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtMailTmplTemplateDto()
        {
            TmplName = string.Empty;
            TmplCode = string.Empty;
            TmplSubject = string.Empty;
