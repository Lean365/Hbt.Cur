...
namespace Lean.Hbt.Application.Dtos.Routine.Vehicle
{
    /// <summary>
    /// 驾驶员基础DTO
    /// </summary>
    public class HbtDriverDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
    ...
    /// 驾驶员查询DTO
    /// </summary>
    public class HbtDriverQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtDriverQueryDto()
        {
            EmployeeName = string.Empty;
            EmployeeNo = string.Empty;
            LicenseNo = string.Empty;
    ...
    /// 驾驶员创建DTO
    /// </summary>
    public class HbtDriverCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtDriverCreateDto()
        {
            EmployeeName = string.Empty;
            EmployeeNo = string.Empty;
            LicenseNo = string.Empty;
    ...
    /// 驾驶员更新DTO
    /// </summary>
    public class HbtDriverUpdateDto : HbtDriverCreateDto
    {
        /// <summary>
        /// ID
        /// </summary>
    ...
    /// 驾驶员删除DTO
    /// </summary>
    public class HbtDriverDeleteDto
    {
    ...
    /// 驾驶员批量删除DTO
    /// </summary>
    public class HbtDriverBatchDeleteDto
    {
    ...
    /// 驾驶员导入DTO
    /// </summary>
    public class HbtDriverImportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtDriverImportDto()
        {
            EmployeeName = string.Empty;
            EmployeeNo = string.Empty;
            LicenseNo = string.Empty;
    ...
    /// 驾驶员导出DTO
    /// </summary>
    public class HbtDriverExportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtDriverExportDto()
        {
            EmployeeName = string.Empty;
            EmployeeNo = string.Empty;
            LicenseNo = string.Empty;
    ...
    /// 驾驶员导入模板DTO
    /// </summary>
    public class HbtDriverTemplateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtDriverTemplateDto()
        {
            EmployeeName = string.Empty;
            EmployeeNo = string.Empty;
            LicenseNo = string.Empty;
