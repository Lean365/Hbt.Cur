...
// 文件名 : HbtNewsTopicRelationDto.cs
// 创建者 : Claude
// 创建时间: 2024-12-01
// 版本号 : V0.0.1
// 描述   : 新闻话题关联数据传输对象
...
namespace Lean.Hbt.Application.Dtos.Routine.News
{
    ...
    /// 新闻话题关联DTO
    /// </summary>
    public class HbtNewsTopicRelationDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsTopicRelationDto()
        {
    ...
    /// 新闻话题关联查询DTO
    /// </summary>
    public class HbtNewsTopicRelationQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 新闻ID
        /// </summary>
    ...
    /// 新闻话题关联创建DTO
    /// </summary>
    public class HbtNewsTopicRelationCreateDto
    {
        /// <summary>
        /// 新闻ID
        /// </summary>
    ...
    /// 新闻话题关联更新DTO
    /// </summary>
    public class HbtNewsTopicRelationUpdateDto : HbtNewsTopicRelationCreateDto
    {
        /// <summary>
        /// 关联ID
        /// </summary>
    ...
    /// 新闻话题关联状态DTO
    /// </summary>
    public class HbtNewsTopicRelationStatusDto
    {
        /// <summary>
        /// 关联ID
        /// </summary>
