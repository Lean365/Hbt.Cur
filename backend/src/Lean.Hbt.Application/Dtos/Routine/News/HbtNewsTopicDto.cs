...
namespace Lean.Hbt.Application.Dtos.Routine.News
{
    ...
    /// 新闻话题基础DTO
    /// </summary>
    public class HbtNewsTopicDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsTopicDto()
        {
        ...
        /// 话题新闻关联列表
        /// </summary>
        public List<HbtNewsTopicRelationDto>? TopicNewsRelations { get; set; }

        /// <summary>
        /// 话题参与者列表
        /// </summary>
        public List<HbtNewsTopicParticipantDto>? TopicParticipants { get; set; }
    }

    /// <summary>
    /// 新闻话题查询DTO
    /// </summary>
    public class HbtNewsTopicQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsTopicQueryDto()
        {
            TopicName = string.Empty;
            TopicCategory = string.Empty;
            TopicCreatorName = string.Empty;
    ...
    /// 新闻话题创建DTO
    /// </summary>
    public class HbtNewsTopicCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsTopicCreateDto()
        {
            TopicName = string.Empty;
            TopicCategory = string.Empty;
        }
    ...
    /// 新闻话题更新DTO
    /// </summary>
    public class HbtNewsTopicUpdateDto : HbtNewsTopicCreateDto
    {
        /// <summary>
        /// 话题ID
        /// </summary>
    ...
    /// 新闻话题导入DTO
    /// </summary>
    public class HbtNewsTopicImportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsTopicImportDto()
        {
            TopicName = string.Empty;
            TopicCategory = string.Empty;
            TopicCreatorName = string.Empty;
    ...
    /// 新闻话题导出DTO
    /// </summary>
    public class HbtNewsTopicExportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsTopicExportDto()
        {
            TopicName = string.Empty;
            TopicCategory = string.Empty;
            TopicCreatorName = string.Empty;
    ...
    /// 新闻话题模板DTO
    /// </summary>
    public class HbtNewsTopicTemplateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsTopicTemplateDto()
        {
            TopicName = string.Empty;
            TopicCategory = string.Empty;
            TopicCreatorName = string.Empty;
    ...
    /// 新闻话题状态DTO
    /// </summary>
    public class HbtNewsTopicStatusDto
    {
        /// <summary>
        /// 话题ID
        /// </summary>
