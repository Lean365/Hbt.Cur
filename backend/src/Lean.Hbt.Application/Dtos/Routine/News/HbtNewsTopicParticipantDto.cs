...
// 文件名 : HbtNewsTopicParticipantDto.cs
// 创建者 : Claude
// 创建时间: 2024-12-01
// 版本号 : V0.0.1
// 描述   : 话题参与者数据传输对象
...
namespace Lean.Hbt.Application.Dtos.Routine.News
{
    ...
    /// 话题参与者DTO
    /// </summary>
    public class HbtNewsTopicParticipantDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsTopicParticipantDto()
        {
        ...
        /// 关联的话题
        /// </summary>
        public HbtNewsTopicDto? Topic { get; set; }
    }

    /// <summary>
    /// 话题参与者查询DTO
    /// </summary>
    public class HbtNewsTopicParticipantQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 话题ID
        /// </summary>
    ...
    /// 话题参与者创建DTO
    /// </summary>
    public class HbtNewsTopicParticipantCreateDto
    {
        /// <summary>
        /// 话题ID
        /// </summary>
    ...
    /// 话题参与者更新DTO
    /// </summary>
    public class HbtNewsTopicParticipantUpdateDto : HbtNewsTopicParticipantCreateDto
    {
        /// <summary>
        /// 参与者ID
        /// </summary>
    ...
    /// 话题参与者状态DTO
    /// </summary>
    public class HbtNewsTopicParticipantStatusDto
    {
        /// <summary>
        /// 参与者ID
        /// </summary>
