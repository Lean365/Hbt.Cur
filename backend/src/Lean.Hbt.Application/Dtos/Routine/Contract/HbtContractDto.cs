...
namespace Lean.Hbt.Application.Dtos.Routine.Contract
{
    /// <summary>
    /// 合同基础DTO
    /// </summary>
    public class HbtContractDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtContractDto()
        {
    ...
    /// 合同查询DTO
    /// </summary>
    public class HbtContractQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtContractQueryDto()
        {
            ContractCode = string.Empty;
            ContractName = string.Empty;
            ContractCategory = string.Empty;
    ...
    /// 合同创建DTO
    /// </summary>
    public class HbtContractCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtContractCreateDto()
        {
            CompanyCode = string.Empty;
            ContractCode = string.Empty;
            ContractName = string.Empty;
    ...
    /// 合同更新DTO
    /// </summary>
    public class HbtContractUpdateDto : HbtContractCreateDto
    {
        /// <summary>
        /// ID
        /// </summary>
    ...
    /// 合同删除DTO
    /// </summary>
    public class HbtContractDeleteDto
    {
    ...
    /// 合同批量删除DTO
    /// </summary>
    public class HbtContractBatchDeleteDto
    {
    ...
    /// 合同导入DTO
    /// </summary>
    public class HbtContractImportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtContractImportDto()
        {
            CompanyCode = string.Empty;
            ContractCode = string.Empty;
            ContractName = string.Empty;
    ...
    /// 合同导出DTO
    /// </summary>
    public class HbtContractExportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtContractExportDto()
        {
            CompanyCode = string.Empty;
            ContractCode = string.Empty;
            ContractName = string.Empty;
    ...
    /// 合同导入模板DTO
    /// </summary>
    public class HbtContractTemplateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtContractTemplateDto()
        {
            CompanyCode = string.Empty;
            ContractCode = string.Empty;
            ContractName = string.Empty;
