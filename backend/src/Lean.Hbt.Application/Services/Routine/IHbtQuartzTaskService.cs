...
namespace Lean.Hbt.Application.Services.Routine
{
    ...
    /// 定时任务服务接口
    /// </summary>
    public interface IHbtQuartzTaskService
    {
        /// <summary>
        /// 获取定时任务分页列表
        /// </summary>
        ...
        Task<long> CreateAsync(HbtQuartzTaskCreateDto input);
        ...
        Task<bool> UpdateAsync(long taskId, HbtQuartzTaskDto input);
        ...
        Task<byte[]> ExportAsync(HbtQuartzTaskQueryDto query, string sheetName = "定时任务数据");
    }
} 