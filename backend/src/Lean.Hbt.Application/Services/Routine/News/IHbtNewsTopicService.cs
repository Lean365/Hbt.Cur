...
namespace Lean.Hbt.Application.Services.Routine.News
{
    ...
    /// 创建时间: 2024-01-01
    /// </remarks>
    public interface IHbtNewsTopicService
    {
        /// <summary>
        /// 获取新闻话题分页列表
        /// </summary>
        ...
        Task<HbtPagedResult<HbtNewsTopicDto>> GetListAsync(HbtNewsTopicQueryDto? query);
        ...
        Task<HbtNewsTopicDto> GetByIdAsync(long id);
        ...
        Task<long> CreateAsync(HbtNewsTopicCreateDto input);
        ...
        Task<bool> UpdateAsync(HbtNewsTopicUpdateDto input);
        ...
        /// <returns>是否成功</returns>
        Task<bool> UpdateStatusAsync(HbtNewsTopicStatusDto input);
        ...
        Task<List<HbtNewsTopicDto>> GetHotTopicsAsync(int count = 10);
        ...
        Task<List<HbtNewsTopicDto>> GetRecommendedTopicsAsync(int count = 10);
        ...
        Task<HbtPagedResult<HbtNewsDto>> GetNewsByTopicIdAsync(long topicId, int pageIndex = 1, int pageSize = 20);
        ...
        Task<HbtPagedResult<HbtNewsTopicDto>> GetUserJoinedTopicsAsync(long userId, int pageIndex = 1, int pageSize = 20);
        ...
        /// <param name="pageSize">页大小</param>
        /// <returns>话题分页列表</returns>
        Task<HbtPagedResult<HbtNewsTopicDto>> SearchTopicsAsync(string keyword, int pageIndex = 1, int pageSize = 20);
