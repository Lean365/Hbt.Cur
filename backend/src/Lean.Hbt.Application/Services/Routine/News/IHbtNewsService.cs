...
namespace Lean.Hbt.Application.Services.Routine.News
{
    ...
    /// 创建时间: 2024-12-01
    /// </remarks>
    public interface IHbtNewsService
    {
        /// <summary>
        /// 获取新闻分页列表
        /// </summary>
        ...
        Task<HbtPagedResult<HbtNewsDto>> GetListAsync(HbtNewsQueryDto query);
        ...
        Task<HbtNewsDto> GetByIdAsync(long id);
        ...
        Task<long> CreateAsync(HbtNewsCreateDto input);
        ...
        Task<bool> UpdateAsync(HbtNewsUpdateDto input);
        ...
        Task<(string fileName, byte[] content)> ExportAsync(HbtNewsQueryDto query, string sheetName);
        ...
        /// <returns>是否成功</returns>
        Task<bool> UpdateStatusAsync(HbtNewsStatusDto input);
        ...
        /// <returns>是否成功</returns>
        Task<bool> AuditAsync(HbtNewsAuditDto input);
        ...
        Task<List<HbtNewsDto>> GetHotNewsAsync(int count = 10);
        ...
        Task<List<HbtNewsDto>> GetRecommendNewsAsync(int count = 10);
        ...
        Task<List<HbtNewsDto>> GetTopNewsAsync(int count = 5);
        ...
        Task<List<HbtNewsDto>> GetNewsByCategoryAsync(string category, int count = 20);
        ...
        /// <param name="count">获取数量</param>
        /// <returns>新闻列表</returns>
        Task<List<HbtNewsDto>> SearchNewsAsync(string keyword, int count = 20);
    }
} 