...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : IHbtNewsTopicParticipantService.cs
// 创建者 : Lean365
// 创建时间: 2024-01-01
// 版本号 : V0.0.1
// 描述    : 新闻话题参与者服务接口
...
namespace Lean.Hbt.Application.Services.Routine.News
{
    ...
    /// 创建时间: 2024-01-01
    /// </remarks>
    public interface IHbtNewsTopicParticipantService
    {
        /// <summary>
        /// 获取新闻话题参与者分页列表
        /// </summary>
        ...
        Task<HbtPagedResult<HbtNewsTopicParticipantDto>> GetListAsync(HbtNewsTopicParticipantQueryDto? query);
        ...
        Task<HbtNewsTopicParticipantDto> GetByIdAsync(long id);
        ...
        Task<long> CreateAsync(HbtNewsTopicParticipantCreateDto input);
        ...
        Task<bool> UpdateAsync(HbtNewsTopicParticipantUpdateDto input);
        ...
        /// <returns>是否成功</returns>
        Task<bool> UpdateStatusAsync(HbtNewsTopicParticipantStatusDto input);
        ...
        Task<HbtPagedResult<HbtNewsTopicParticipantDto>> GetTopicParticipantsAsync(long topicId, int pageIndex = 1, int pageSize = 20);
        ...
        Task<HbtPagedResult<HbtNewsTopicParticipantDto>> GetUserJoinedTopicsAsync(long userId, int pageIndex = 1, int pageSize = 20);
        ...
        Task<List<HbtNewsTopicParticipantDto>> GetActiveUsersAsync(long topicId, int count = 10);
        ...
        Task<List<HbtNewsTopicParticipantDto>> GetTopContributorsAsync(long topicId, int count = 10);
        ...
        /// <param name="pageSize">页大小</param>
        /// <returns>参与者分页列表</returns>
        Task<HbtPagedResult<HbtNewsTopicParticipantDto>> SearchParticipantsAsync(string keyword, int pageIndex = 1, int pageSize = 20);
