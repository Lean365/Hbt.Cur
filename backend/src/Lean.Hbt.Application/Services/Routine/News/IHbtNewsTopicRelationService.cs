...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : IHbtNewsTopicRelationService.cs
// 创建者 : Lean365
// 创建时间: 2024-01-01
// 版本号 : V0.0.1
// 描述    : 新闻话题关系服务接口
...
namespace Lean.Hbt.Application.Services.Routine.News
{
    ...
    /// 创建时间: 2024-01-01
    /// </remarks>
    public interface IHbtNewsTopicRelationService
    {
        /// <summary>
        /// 获取新闻话题关系分页列表
        /// </summary>
        ...
        Task<HbtPagedResult<HbtNewsTopicRelationDto>> GetListAsync(HbtNewsTopicRelationQueryDto? query);
        ...
        Task<HbtNewsTopicRelationDto> GetByIdAsync(long id);
        ...
        Task<long> CreateAsync(HbtNewsTopicRelationCreateDto input);
        ...
        Task<bool> UpdateAsync(HbtNewsTopicRelationUpdateDto input);
        ...
        /// <returns>是否成功</returns>
        Task<bool> UpdateStatusAsync(HbtNewsTopicRelationStatusDto input);
        ...
        Task<List<HbtNewsTopicRelationDto>> GetTopicsByNewsIdAsync(long newsId);
        ...
        Task<List<HbtNewsTopicRelationDto>> GetNewsByTopicIdAsync(long topicId);
        ...
        Task<List<HbtNewsTopicDto>> MatchTopicsByKeywordsAsync(string keywords, int count = 5);
    }
}