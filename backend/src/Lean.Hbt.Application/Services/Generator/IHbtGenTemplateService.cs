...
/// 用于管理代码生成的模板信息
/// </summary>
public interface IHbtGenTemplateService
{
    #region 基础操作
    ...
    Task<HbtGenTemplateDto?> GetByIdAsync(long id);
    ...
    Task<HbtPagedResult<HbtGenTemplateDto>> GetListAsync(HbtGenTemplateQueryDto input);
    ...
    Task<HbtGenTemplateDto> CreateAsync(HbtGenTemplateCreateDto input);
    ...
    Task<HbtGenTemplateDto> UpdateAsync(HbtGenTemplateUpdateDto input);
    ...
    Task<(int success, int fail)> ImportTemplatesAsync(Stream fileStream, string sheetName = "Sheet1");
