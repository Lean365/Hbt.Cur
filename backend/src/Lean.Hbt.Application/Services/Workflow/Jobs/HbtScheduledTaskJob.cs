...
namespace Lean.Hbt.Application.Services.Workflow.Jobs
{
    ...
    /// 工作流调度任务基类
    /// </summary>
    public abstract class HbtScheduledTaskJob : IJob
    {
        /// <summary>
        /// 服务提供器
        /// </summary>
        ...
        /// 调度任务服务
        /// </summary>
        protected readonly IHbtScheduledTaskService _scheduledTaskService;
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                ...
                var task = await dbContext.Client.Queryable<HbtScheduledTask>()
                ...
                catch (Exception ex)
                {
                    ...
                    if (task.RetryCount < task.MaxRetryCount)
                    {
                        ...
                        // 更新重试次数
                        await dbContext.Client.Updateable<HbtScheduledTask>()
        ...
        /// 执行具体的调度任务
        /// </summary>
        protected abstract Task ExecuteTaskAsync(HbtScheduledTask task);
    }
}