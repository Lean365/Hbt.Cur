...
namespace Lean.Hbt.Application.Services.Identity
{
    ...
    public interface IHbtDeviceExtendService
    {
        ...
        Task<HbtPagedResult<HbtDeviceExtendDto>> GetPagedListAsync(HbtDeviceExtendPageRequest query);
        ...
        Task<byte[]> ExportAsync(HbtDeviceExtendExportRequest request);
        ...
        Task<HbtDeviceExtendDto> UpdateDeviceInfoAsync(HbtDeviceExtendUpdateRequest request);
        ...
        /// <returns>更新后的设备扩展信息</returns>
        Task<HbtDeviceExtendDto> UpdateOnlinePeriodAsync(HbtDeviceOnlinePeriodUpdateRequest request);
