...
namespace Hbt.Cur.Application.Dtos.Routine.News
{
    ...
    /// 新闻查询DTO
    /// </summary>
    public class HbtNewsQueryDto : HbtPagedQuery
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsQueryDto()
        {
            NewsTitle = string.Empty;
            NewsCategory = string.Empty;
            NewsAuthor = string.Empty;
    ...
    /// 新闻创建DTO
    /// </summary>
    public class HbtNewsCreateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsCreateDto()
        {
            NewsTitle = string.Empty;
            NewsContent = string.Empty;
            NewsCategory = string.Empty;
    ...
    /// 新闻更新DTO
    /// </summary>
    public class HbtNewsUpdateDto : HbtNewsCreateDto
    {
        /// <summary>
        /// 新闻ID
        /// </summary>
    ...
    /// 新闻导入DTO
    /// </summary>
    public class HbtNewsImportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsImportDto()
        {
            NewsTitle = string.Empty;
            NewsContent = string.Empty;
            NewsCategory = string.Empty;
    ...
    /// 新闻导出DTO
    /// </summary>
    public class HbtNewsExportDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsExportDto()
        {
            NewsTitle = string.Empty;
            NewsContent = string.Empty;
            NewsCategory = string.Empty;
    ...
    /// 新闻模板DTO
    /// </summary>
    public class HbtNewsTemplateDto
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HbtNewsTemplateDto()
        {
            NewsTitle = string.Empty;
            NewsContent = string.Empty;
            NewsCategory = string.Empty;
