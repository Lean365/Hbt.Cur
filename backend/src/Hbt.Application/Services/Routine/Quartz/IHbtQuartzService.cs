...
namespace Hbt.Cur.Application.Services.Routine.Quartz
{
    ...
    /// 定时任务服务接口
    /// </summary>
    public interface IHbtQuartzService
    {
        /// <summary>
        /// 获取定时任务分页列表
        /// </summary>
        ...
        Task<HbtPagedResult<HbtQuartzDto>> GetListAsync(HbtQuartzQueryDto query);
        ...
        Task<HbtQuartzDto> GetByIdAsync(long taskId);
        ...
        Task<long> CreateAsync(HbtQuartzCreateDto input);
        ...
        Task<bool> UpdateAsync(long taskId, HbtQuartzDto input);
