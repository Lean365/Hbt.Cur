...
namespace Hbt.Application.Services.Workflow.Jobs
{
    ...
    public class HbtCleanupJob : IJob
    {
        /// <summary>
        /// 仓储工厂
        /// </summary>
        ...
        /// 获取工作流流转记录仓储
        /// </summary>
        private IHbtRepository<HbtInstanceTrans> InstanceTransRepository => _repositoryFactory.GetWorkflowRepository<HbtInstanceTrans>();
