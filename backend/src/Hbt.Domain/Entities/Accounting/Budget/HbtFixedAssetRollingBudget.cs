...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtFixedAssetRollingBudget.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 固定资产滚动预算实体类 (基于SAP FI-AA固定资产滚动预算管理)
...
{
    /// <summary>
    /// 固定资产滚动预算实体类 (基于SAP FI-AA固定资产滚动预算管理)
    /// </summary>
    /// <remarks>
    /// 创建者: Lean365
    /// 创建时间: 2024-03-07
    /// 参考: SAP FI-AA 固定资产管理
    /// </remarks>
    [SugarTable("hbt_accounting_budget_fixed_asset_rolling_budget", "固资滚动")]
    [SugarIndex("ix_fixed_asset_rolling_budget_code", nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(AssetCode), OrderByType.Asc, nameof(FiscalYear), OrderByType.Asc, nameof(FiscalPeriod), OrderByType.Asc, true)]
    [SugarIndex("ix_company_plant", nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, false)]
    public class HbtFixedAssetRollingBudget : HbtBaseEntity
    {
        /// <summary>
        /// 公司代码
        /// </summary>
