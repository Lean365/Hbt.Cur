...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtCostBudget.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 成本预算实体类 (基于SAP CO成本预算管理)
...
namespace Hbt.Domain.Entities.Accounting.Budget
{
    ...
    /// </remarks>
    [SugarTable("hbt_accounting_budget_cost_budget", "成本预算")]
    [SugarIndex("ix_cost_budget_code", nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(CostCenterCode), OrderByType.Asc, nameof(FiscalYear), OrderByType.Asc, nameof(FiscalPeriod), OrderByType.Asc, true)]
    ...
    public class HbtCostBudget : HbtBaseEntity
    {
        ...
        /// <summary>
        /// 预算类型(1=年度预算 2=月度预算 3=季度预算 4=专项预算)
        /// </summary>
