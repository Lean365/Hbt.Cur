...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtOfficeSupplyPurchaseRequestDetail.cs
// 创建者 : Lean365
// 创建时间: 2024-12-01
// 版本号 : V0.0.1
// 描述    : 办公用品请购申请明细表实体类
...
namespace Hbt.Cur.Domain.Entities.Routine.OfficeSupply
{
    ...
    /// </remarks>
    [SugarTable("hbt_routine_office_supply_purchase_request_detail", "办公用品请购申请明细")]
    ...
    public class HbtOfficeSupplyPurchaseRequestDetail : HbtBaseEntity
    {
