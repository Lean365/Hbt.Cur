...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtOfficeSupplyPurchaseRequest.cs
// 创建者 : Lean365
// 创建时间: 2024-12-01
// 版本号 : V0.0.1
// 描述    : 办公用品请购申请主表实体类
...
namespace Hbt.Cur.Domain.Entities.Routine.OfficeSupply
{
    ...
    /// 创建者: Lean365
    /// 创建时间: 2024-12-01
    /// 说明: 记录办公用品请购申请的主表信息，包括申请人、申请原因、审批状态等
    /// </remarks>
    [SugarTable("hbt_routine_office_supply_purchase_request", "办公用品请购申请")]
    [SugarIndex("ix_office_supply_purchase_request_code", nameof(RequestCode), OrderByType.Asc, true)]
    [SugarIndex("ix_company_office_supply_purchase_request", nameof(CompanyCode), OrderByType.Asc, nameof(RequestCode), OrderByType.Asc, false)]
    [SugarIndex("ix_office_supply_purchase_request_applicant", nameof(ApplicantId), OrderByType.Asc, false)]
    [SugarIndex("ix_office_supply_purchase_request_status", nameof(Status), OrderByType.Asc, false)]
    [SugarIndex("ix_office_supply_purchase_request_create_time", nameof(CreateTime), OrderByType.Desc, false)]
    public class HbtOfficeSupplyPurchaseRequest : HbtBaseEntity
    {
