...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtOfficialDocumentReceipt.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 公文文档签收实体类
...
namespace Hbt.Domain.Entities.Routine.Document
{
    ...
    /// </remarks>
    [SugarTable("hbt_routine_official_document_receipt", "公文文档签收表")]
    ...
    public class HbtOfficialDocumentReceipt : HbtBaseEntity
    {
        ...
        public HbtOfficialDocument? Document { get; set; }
    }
}