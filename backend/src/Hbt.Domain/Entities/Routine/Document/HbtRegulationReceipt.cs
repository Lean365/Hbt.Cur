...
namespace Hbt.Domain.Entities.Routine.Document
{
    ...
    /// </remarks>
    [SugarTable("hbt_routine_regulation_receipt", "内部规章制度签收表")]
    ...
    public class HbtRegulationReceipt : HbtBaseEntity
    {
        ...
        public HbtRegulation? Regulation { get; set; }
    }
}