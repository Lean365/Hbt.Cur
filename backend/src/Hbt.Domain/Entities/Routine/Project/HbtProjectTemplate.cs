...
namespace Hbt.Cur.Domain.Entities.Routine.Project
{
    /// <summary>
    /// 项目模板实体类
    /// </summary>
    ...
    /// 创建者: Lean365
    /// 创建时间: 2024-03-07
    /// 说明: 记录项目模板的基本信息，包括模板配置、版本管理等
    /// </remarks>
    [SugarTable("hbt_routine_project_template", "项目模板表")]
    [SugarIndex("ix_project_template_code", nameof(ProjectTemplateCode), OrderByType.Asc, true)]
    [SugarIndex("ix_company_project_template", nameof(CompanyCode), OrderByType.Asc, nameof(ProjectTemplateCode), OrderByType.Asc, false)]
    [SugarIndex("ix_project_template_status", nameof(ProjectTemplateStatus), OrderByType.Asc, false)]
    [SugarIndex("ix_project_template_type", nameof(ProjectTemplateType), OrderByType.Asc, false)]
    public class HbtProjectTemplate : HbtBaseEntity
    {
        /// <summary>公司代码</summary>
        [SugarColumn(ColumnName = "company_code", ColumnDescription = "公司代码", Length = 10, ColumnDataType = "nvarchar", IsNullable = false)]
        public string CompanyCode { get; set; } = string.Empty;

        /// <summary>项目模板编号</summary>
        [SugarColumn(ColumnName = "project_template_code", ColumnDescription = "项目模板编号", Length = 20, ColumnDataType = "nvarchar", IsNullable = false)]
        public string ProjectTemplateCode { get; set; } = string.Empty;

        /// <summary>项目模板名称</summary>
        [SugarColumn(ColumnName = "project_template_name", ColumnDescription = "项目模板名称", Length = 200, ColumnDataType = "nvarchar", IsNullable = false)]
        public string ProjectTemplateName { get; set; } = string.Empty;

        /// <summary>项目模板类型(1=研发项目模板 2=实施项目模板 3=维护项目模板 4=咨询项目模板 5=培训项目模板 6=其他项目模板)</summary>
        [SugarColumn(ColumnName = "project_template_type", ColumnDescription = "项目模板类型", ColumnDataType = "int", IsNullable = false, DefaultValue = "1")]
        public int ProjectTemplateType { get; set; } = 1;

        /// <summary>项目模板分类</summary>
        [SugarColumn(ColumnName = "project_template_category", ColumnDescription = "项目模板分类", Length = 50, ColumnDataType = "nvarchar", IsNullable = true)]
        public string? ProjectTemplateCategory { get; set; }

        /// <summary>项目模板描述</summary>
        [SugarColumn(ColumnName = "project_template_description", ColumnDescription = "项目模板描述", Length = 1000, ColumnDataType = "nvarchar", IsNullable = true)]
        public string? ProjectTemplateDescription { get; set; }

        /// <summary>项目模板内容</summary>
        [SugarColumn(ColumnName = "project_template_content", ColumnDescription = "项目模板内容", Length = 8000, ColumnDataType = "nvarchar", IsNullable = true)]
        ...
        /// <summary>项目模板状态(0=草稿 1=待审核 2=已审核 3=已发布 4=已作废 5=已归档)</summary>
        [SugarColumn(ColumnName = "project_template_status", ColumnDescription = "项目模板状态", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
        public int ProjectTemplateStatus { get; set; } = 0;
        ...
        /// <summary>备注</summary>
        [SugarColumn(ColumnName = "project_template_remark", ColumnDescription = "备注", Length = 500, ColumnDataType = "nvarchar", IsNullable = true)]
        public string? ProjectTemplateRemark { get; set; }
