...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtProjectDocumentCommunication.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 项目文档与沟通实体类
...
namespace Hbt.Cur.Domain.Entities.Routine.Project
{
    ...
    /// </remarks>
    [SugarTable("hbt_routine_project_document_communication", "项目文档与沟通表")]
    ...
    public class HbtProjectDocumentCommunication : HbtBaseEntity
    {
