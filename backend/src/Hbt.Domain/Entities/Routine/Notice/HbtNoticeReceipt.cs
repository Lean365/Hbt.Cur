...
namespace Hbt.Cur.Domain.Entities.Routine.Notice
{
    /// <summary>
    /// 通知签收实体
    /// </summary>
    [SugarTable("hbt_routine_notice_receipt", "通知签收")]
    ...
    public class HbtNoticeReceipt : HbtBaseEntity
    {
        /// <summary>
        /// 通知ID
        /// </summary>
        ...
        /// 是否已读（0：未读，1：已读）
        /// </summary>
        [SugarColumn(ColumnName = "is_read", ColumnDescription = "是否已读（0：未读，1：已读）", IsNullable = false, DefaultValue = "0", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
        ...
        /// 是否已确认（0：未确认，1：已确认）
        /// </summary>
        [SugarColumn(ColumnName = "is_confirm", ColumnDescription = "是否已确认（0：未确认，1：已确认）", IsNullable = false, DefaultValue = "0", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
        ...
        /// </summary>
        [SugarColumn(ColumnName = "confirm_status", ColumnDescription = "确认状态（0：待确认，1：同意，2：不同意，3：有意见）", IsNullable = false, DefaultValue = "0", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
        public int ConfirmStatus { get; set; }

        /// <summary>
        /// 是否已回复（0：未回复，1：已回复）
        /// </summary>
        [SugarColumn(ColumnName = "is_reply", ColumnDescription = "是否已回复（0：未回复，1：已回复）", IsNullable = false, DefaultValue = "0", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
        ...
        /// 是否已转发（0：未转发，1：已转发）
        /// </summary>
        [SugarColumn(ColumnName = "is_forward", ColumnDescription = "是否已转发（0：未转发，1：已转发）", IsNullable = false, DefaultValue = "0", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
        ...
        /// 是否已收藏（0：未收藏，1：已收藏）
        /// </summary>
        [SugarColumn(ColumnName = "is_favorite", ColumnDescription = "是否已收藏（0：未收藏，1：已收藏）", IsNullable = false, DefaultValue = "0", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
        ...
        /// 是否已归档（0：未归档，1：已归档）
        /// </summary>
        [SugarColumn(ColumnName = "is_archived", ColumnDescription = "是否已归档（0：未归档，1：已归档）", IsNullable = false, DefaultValue = "0", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
