...
{
    /// <summary>
    /// BOM物料项变更表（记录HbtBomItem所有字段的变更）
    /// </summary>
    [SugarTable("hbt_logistics_change_bom_item", "BOM物料项变更表")]
    ...
    public class HbtChangeBomItem : HbtBaseEntity
    {
