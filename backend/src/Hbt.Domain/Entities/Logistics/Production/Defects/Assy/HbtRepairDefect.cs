...
namespace Hbt.Domain.Entities.Logistics.Production
{
    ...
    /// 参考: 改修不良日报管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_repair_defect", "改修不良")]
    ...
    public class HbtRepairDefect : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// 改修不良明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtRepairDefectDetail.RepairDefectId))]
        public List<HbtRepairDefectDetail>? RepairDefectDetails { get; set; }
    }
} 