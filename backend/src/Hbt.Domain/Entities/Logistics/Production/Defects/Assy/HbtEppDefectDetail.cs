...
namespace Hbt.Domain.Entities.Logistics.Production
{
    ...
    /// 参考: EPP不良明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_epp_defect_detail", "EPP不良明细表")]
    [SugarIndex("ix_epp_defect_id", nameof(EppDefectId), OrderByType.Asc, false)]
    [SugarIndex("ix_hour_no", nameof(HourNo), OrderByType.Asc, false)]
    public class HbtEppDefectDetail : HbtBaseEntity
    {
        /// <summary>
        /// EPP不良日报ID
        /// </summary>
        [SugarColumn(ColumnName = "epp_defect_id", ColumnDescription = "EPP不良ID", ColumnDataType = "bigint", IsNullable = false)]
        public long EppDefectId { get; set; }
        ...
        /// EPP不良数量
        /// </summary>
        [SugarColumn(ColumnName = "epp_defect_quantity", ColumnDescription = "EPP不良数量", ColumnDataType = "decimal(18,3)", IsNullable = false, DefaultValue = "0")]
        public decimal EppDefectQuantity { get; set; } = 0;
        ...
        /// EPP不良率(%)
        /// </summary>
        [SugarColumn(ColumnName = "epp_defect_rate", ColumnDescription = "EPP不良率", ColumnDataType = "decimal(5,2)", IsNullable = false, DefaultValue = "0")]
        public decimal EppDefectRate { get; set; } = 0;
        ...
        /// EPP不良日报
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(EppDefectId))]
        public HbtEppDefect? EppDefect { get; set; }
    }
} 