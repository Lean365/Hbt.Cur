...
namespace Hbt.Cur.Domain.Entities.Logistics.Production
{
    ...
    /// 参考: EPP不良日报管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_epp_defect", "EPP不良")]
    ...
    public class HbtEppDefect : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// EPP不良明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtEppDefectDetail.EppDefectId))]
        public List<HbtEppDefectDetail>? EppDefectDetails { get; set; }
    }
} 