...
namespace Hbt.Domain.Entities.Logistics.Production.Outputs.Assy
{
    ...
    /// 参考: 组立返工日报管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_assy_rework_output", "组立返工日报表")]
    ...
    public class HbtAssyReworkOutput : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// 返工数量
        /// </summary>
        [SugarColumn(ColumnName = "rework_qty", ColumnDescription = "返工数量", ColumnDataType = "decimal(18,3)", IsNullable = false, DefaultValue = "0")]
        ...
        /// 组立返工明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtAssyRwrOutputDetail.AssyRwrOutputId))]
        public List<HbtAssyRwrOutputDetail>? AssyRwrOutputDetails { get; set; }
    }
} 