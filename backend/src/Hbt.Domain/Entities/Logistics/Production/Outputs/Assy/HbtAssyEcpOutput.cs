...
namespace Hbt.Domain.Entities.Logistics.Production.Outputs.Assy
{
    ...
    /// 参考: 组立改修日报管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_assy_modify_output", "组立改修")]
    ...
    public class HbtAssyEcpOutput : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// 改修数量
        /// </summary>
        [SugarColumn(ColumnName = "repair_qty", ColumnDescription = "改修数量", ColumnDataType = "decimal(18,3)", IsNullable = false, DefaultValue = "0")]
        ...
        /// 组立改修明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtAssyEcpOutputDetail.AssyEcpOutputId))]
        public List<HbtAssyEcpOutputDetail>? AssyEcpOutputDetails { get; set; }
    }
} 