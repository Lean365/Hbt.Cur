...
namespace Hbt.Domain.Entities.Logistics.Production.Outputs.Assy
{
    ...
    /// 参考: 组立生产明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_assy_mp_output_detail", "组立明细表")]
    [SugarIndex("ix_assy_output_id", nameof(AssyMpOutputId), OrderByType.Asc, false)]
    public class HbtAssyMpOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// 组立日报ID
        /// </summary>
        ...
        /// 实际生产数量
        /// </summary>
        [SugarColumn(ColumnName = "actual_qty", ColumnDescription = "实际数量", ColumnDataType = "decimal", Length = 18, DecimalDigits = 1, IsNullable = false, DefaultValue = "0")]
        ...
        /// 组立日报
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(AssyMpOutputId))]
        public HbtAssyMpOutput? AssyMpOutput { get; set; }
    }
} 