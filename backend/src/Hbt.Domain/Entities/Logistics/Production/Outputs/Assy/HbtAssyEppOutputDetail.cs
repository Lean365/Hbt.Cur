...
namespace Hbt.Domain.Entities.Logistics.Production.Outputs.Assy
{
    ...
    /// 参考: 组立EPP明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_assy_epp_output_detail", "组立EPP明细表")]
    [SugarIndex("ix_assy_epp_output_id", nameof(AssyEppOutputId), OrderByType.Asc, false)]
    public class HbtAssyEppOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// 组立EPP日报ID
        /// </summary>
        [SugarColumn(ColumnName = "assy_epp_output_id", ColumnDescription = "组立EPPID", ColumnDataType = "bigint", IsNullable = false)]
        public long AssyEppOutputId { get; set; }
        ...
        /// 实际生产数量
        /// </summary>
        [SugarColumn(ColumnName = "actual_epp_qty", ColumnDescription = "实际生产数量", ColumnDataType = "decimal", Length = 18, DecimalDigits = 1, IsNullable = false, DefaultValue = "0")]
        ...
        /// 组立EPP日报
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(AssyEppOutputId))]
        public HbtAssyEppOutput? AssyEppOutput { get; set; }
    }
} 