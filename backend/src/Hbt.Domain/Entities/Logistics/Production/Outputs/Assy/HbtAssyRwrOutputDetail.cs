...
namespace Hbt.Domain.Entities.Logistics.Production.Outputs.Assy
{
    ...
    [SugarIndex("ix_assy_rework_output_id", nameof(AssyRwrOutputId), OrderByType.Asc, false)]
    public class HbtAssyRwrOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// 组立返工日报ID
        /// </summary>
        [SugarColumn(ColumnName = "assy_rework_output_id", ColumnDescription = "组立返工日报ID", ColumnDataType = "bigint", IsNullable = false)]
        public long AssyRwrOutputId { get; set; }
        ...
        /// 实际返工数量
        /// </summary>
        [SugarColumn(ColumnName = "actual_rework_qty", ColumnDescription = "实际数量", ColumnDataType = "decimal", Length = 18, DecimalDigits = 1, IsNullable = false, DefaultValue = "0")]
        public decimal ActualReworkQty { get; set; } = 0;
        ...
        /// 组立返工日报
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(AssyRwrOutputId))]
        public HbtAssyReworkOutput? AssyRwrOutput { get; set; }
    }
} 