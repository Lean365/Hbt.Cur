...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtAssyRepairDailyDetail.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 组立改修明细实体类
...
namespace Hbt.Domain.Entities.Logistics.Production.Outputs.Assy
{
    /// <summary>
    /// 组立改修明细实体类
    /// </summary>
    ...
    /// 参考: 组立改修明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_assy_modify_output_detail", "组立改修明细表")]
    [SugarIndex("ix_assy_modify_output_id", nameof(AssyEcpOutputId), OrderByType.Asc, false)]
    public class HbtAssyEcpOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// 组立改修日报ID
        /// </summary>
        [SugarColumn(ColumnName = "assy_modify_output_id", ColumnDescription = "组立改修ID", ColumnDataType = "bigint", IsNullable = false)]
        public long AssyEcpOutputId { get; set; }
        ...
        /// 实际改修数量
        /// </summary>
        [SugarColumn(ColumnName = "actual_repair_qty", ColumnDescription = "实际数量", ColumnDataType = "decimal", Length = 18, DecimalDigits = 1, IsNullable = false, DefaultValue = "0")]
        public decimal ActualRepairQty { get; set; } = 0;
        ...
        /// 组立改修日报
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(AssyEcpOutputId))]
        public HbtAssyEcpOutput? AssyEcpOutput { get; set; }
    }
} 