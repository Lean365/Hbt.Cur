...
namespace Hbt.Cur.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA生产明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_ecp_output_detail", "PCBA ECP产出明细表")]
    [SugarIndex("ix_pcba_ecp_output_id", nameof(PcbaEcpOutputId), OrderByType.Asc, false)]
    [SugarIndex("ix_hour_no", nameof(HourNo), OrderByType.Asc, false)]
    public class HbtPcbaEcpOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// PCBA日报ID
        /// </summary>
        [SugarColumn(ColumnName = "pcba_ecp_output_id", ColumnDescription = "PCBA ECP产出ID", ColumnDataType = "bigint", IsNullable = false)]
        public long PcbaEcpOutputId { get; set; }
        ...
        /// PCBA日报
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(PcbaEcpOutputId))]
        public HbtPcbaEcpOutput? PcbaEcpOutput { get; set; }
    }
} 