...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtPcbaEppSmtDaily.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : PCBA SMT EPP日报实体类
...
namespace Hbt.Cur.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA SMT EPP日报管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_epp_smt_output", "PCBA SMT EPP产出")]
    ...
    public class HbtPcbaEppSmtOutput : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// PCBA SMT EPP明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtPcbaEppSmtOutputDetail.PcbaEppSmtOutputId))]
        public List<HbtPcbaEppSmtOutputDetail>? PcbaEppSmtOutputDetails { get; set; }
    }
} 