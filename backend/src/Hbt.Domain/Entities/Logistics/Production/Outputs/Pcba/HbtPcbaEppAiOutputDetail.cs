...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtPcbaEppAiDailyDetail.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : PCBA自插EPP明细实体类
...
namespace Hbt.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA自插EPP明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_epp_ai_output_detail", "PCBA自插EPP产出明细表")]
    [SugarIndex("ix_pcba_epp_ai_output_id", nameof(PcbaEppAiOutputId), OrderByType.Asc, false)]
    public class HbtPcbaEppAiOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// PCBA自插EPP输出ID
        /// </summary>
        [SugarColumn(ColumnName = "pcba_epp_ai_output_id", ColumnDescription = "PCBA自插EPP输出ID", ColumnDataType = "bigint", IsNullable = false)]
        public long PcbaEppAiOutputId { get; set; }
        ...
        /// PCBA自插EPP日报
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(PcbaEppAiOutputId))]
        public HbtPcbaEppAiOutput? PcbaEppAiOutput { get; set; }
    }
} 