...
namespace Hbt.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA SMT输出明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_mp_smt_output_detail", "PCBA SMT产出明细表")]
    [SugarIndex("ix_pcba_mp_smt_output_id", nameof(PcbaMpSmtOutputId), OrderByType.Asc, false)]
    public class HbtPcbaMpSmtOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// PCBA SMT输出ID
        /// </summary>
        [SugarColumn(ColumnName = "pcba_smt_output_id", ColumnDescription = "PCBA SMT输出ID", ColumnDataType = "bigint", IsNullable = false)]
        public long PcbaMpSmtOutputId { get; set; }
        ...
        /// PCBA SMT输出
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(PcbaMpSmtOutputId))]
        public HbtPcbaMpSmtOutput? PcbaMpSmtOutput { get; set; }
    }
} 