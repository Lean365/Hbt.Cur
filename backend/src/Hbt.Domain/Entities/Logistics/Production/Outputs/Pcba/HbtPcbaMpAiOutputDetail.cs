...
namespace Hbt.Cur.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA自插输出明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_mp_ai_output_detail", "PCBA 本产自插产出明细表")]
    [SugarIndex("ix_pcba_mp_ai_output_id", nameof(PcbaMpAiOutputId), OrderByType.Asc, false)]
    public class HbtPcbaMpAiOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// PCBA自插输出ID
        /// </summary>
        [SugarColumn(ColumnName = "pcba_ai_output_id", ColumnDescription = "PCBA自插输出ID", ColumnDataType = "bigint", IsNullable = false)]
        public long PcbaMpAiOutputId { get; set; }
        ...
        /// PCBA自插输出
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(PcbaMpAiOutputId))]
        public HbtPcbaMpAiOutput? PcbaMpAiOutput { get; set; }
    }
} 