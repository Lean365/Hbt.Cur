...
namespace Hbt.Cur.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA返工明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_rwr_output_detail", "PCBA 返工产出明细表")]
    ...
    public class HbtPcbaRwrOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// PCBA返工日报ID
        /// </summary>
        ...
        public HbtPcbaRwrOutput? PcbaRwrOutput { get; set; }
    }
} 