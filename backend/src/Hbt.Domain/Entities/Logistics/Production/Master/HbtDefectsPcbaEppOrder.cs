...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtDefectsPcbaEppOrder.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : PCBA EPP工单组立不良统计实体类
...
namespace Hbt.Cur.Domain.Entities.Logistics.Production
{
    ...
    /// 创建者: Lean365
    /// 创建时间: 2024-03-07
    /// 参考: PCBA EPP工单组立不良统计管理
    /// </remarks>
    [SugarTable("hbt_logistics_pcba_epp_defects_order", "PCBA EPP工单组立不良统计表")]
    ...
    public class HbtDefectsPcbaEppOrder : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
