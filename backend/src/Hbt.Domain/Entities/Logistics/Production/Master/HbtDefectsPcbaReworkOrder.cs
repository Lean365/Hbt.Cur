...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtDefectsPcbaReworkOrder.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : PCBA Rework工单组立不良统计实体类
...
{
    /// <summary>
    /// PCBA Rework工单组立不良统计实体类
    /// </summary>
    /// <remarks>
    /// 创建者: Lean365
    /// 创建时间: 2024-03-07
    /// 参考: PCBA Rework工单组立不良统计管理
    /// </remarks>
    [SugarTable("hbt_logistics_pcba_rework_defects_order", "PCBA Rework工单组立不良统计表")]
    ...
    public class HbtDefectsPcbaReworkOrder : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
