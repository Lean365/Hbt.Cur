...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtDefectsPcbaReworkLot.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : PCBA Rework批次组立不良统计实体类
...
{
    /// <summary>
    /// PCBA Rework批次组立不良统计实体类
    /// </summary>
    /// <remarks>
    /// 创建者: Lean365
    /// 创建时间: 2024-03-07
    /// 参考: PCBA Rework批次组立不良统计管理
    /// </remarks>
    [SugarTable("hbt_logistics_pcba_rework_defects_lot", "PCBA Rework批次组立不良统计表")]
    [SugarIndex("ix_plant_code", nameof(PlantCode), OrderByType.Asc, false)]
    [SugarIndex("ix_batch_no", nameof(BatchNo), OrderByType.Asc, false)]
    ...
    public class HbtDefectsPcbaReworkLot : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// 批次号
        /// </summary>
        [SugarColumn(ColumnName = "batch_no", ColumnDescription = "批次号", Length = 20, ColumnDataType = "nvarchar", IsNullable = false)]
