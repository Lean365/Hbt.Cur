...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtDefectsAssyRepairLot.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : Repair批次组立不良统计实体类
...
namespace Hbt.Domain.Entities.Logistics.Production
{
    ...
    /// 参考: Repair批次组立不良统计管理
    /// </remarks>
    [SugarTable("hbt_logistics_assy_repair_defects_lot", "Repair批次组立不良统计表")]
    ...
    public class HbtDefectsAssyRepairLot : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
