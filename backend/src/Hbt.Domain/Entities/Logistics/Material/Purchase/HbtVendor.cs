...
namespace Hbt.Domain.Entities.Logistics.Purchase
{
    ...
    /// 供应商主数据
    /// </summary>
    [SugarTable("hbt_logistics_purchase_vendor", "卖方主数据")]
    [SugarIndex("ix_vendor_code", nameof(VendorCode), OrderByType.Asc, true)]
    public class HbtVendor : HbtBaseEntity
    {

        /// <summary>供应商代码</summary>
        [SugarColumn(ColumnName = "vendor_code", ColumnDescription = "供应商代码", Length = 20, ColumnDataType = "nvarchar", IsNullable = false)]
        public string VendorCode { get; set; } = string.Empty;
        /// <summary>供应商名称1</summary>
        [SugarColumn(ColumnName = "vendor_name1", ColumnDescription = "供应商名称1", Length = 70, ColumnDataType = "nvarchar", IsNullable = true)]
        public string? VendorName1 { get; set; }
        /// <summary>供应商名称2</summary>
        [SugarColumn(ColumnName = "vendor_name2", ColumnDescription = "供应商名称2", Length = 70, ColumnDataType = "nvarchar", IsNullable = true)]
        public string? VendorName2 { get; set; }
        /// <summary>供应商简称</summary>
        [SugarColumn(ColumnName = "vendor_short_name", ColumnDescription = "供应商简称", Length = 20, ColumnDataType = "nvarchar", IsNullable = true)]
        ...
        [SugarColumn(ColumnName = "vendor_group", ColumnDescription = "供应商分组", Length = 4, ColumnDataType = "nvarchar", IsNullable = true)]
        ...
        [SugarColumn(ColumnName = "vendor_status", ColumnDescription = "供应商状态", Length = 20, ColumnDataType = "nvarchar", IsNullable = true)]
        public string? VendorStatus { get; set; }

        /// <summary>供应商等级</summary>
        [SugarColumn(ColumnName = "vendor_level", ColumnDescription = "供应商等级", Length = 20, ColumnDataType = "nvarchar", IsNullable = true)]
