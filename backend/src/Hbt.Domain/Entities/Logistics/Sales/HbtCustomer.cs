...
namespace Hbt.Cur.Domain.Entities.Logistics.Sales
{
    /// <summary>
    /// 客户实体类
    /// </summary>
    ...
    /// 创建时间: 2024-03-07
    /// </remarks>
    [SugarTable("hbt_logistics_sales_customer", "顾客信息")]
    [SugarIndex("ix_customer_code", nameof(CustomerCode), OrderByType.Asc, true)]
    [SugarIndex("ix_company_customer", nameof(CompanyCode), OrderByType.Asc, nameof(CustomerCode), OrderByType.Asc, false)]
    public class HbtCustomer : HbtBaseEntity
    {
        ...
        [SugarColumn(ColumnName = "customer_type", ColumnDescription = "客户类型", ColumnDataType = "int", IsNullable = false, DefaultValue = "2")]
        public int CustomerType { get; set; } = 2;

        /// <summary>客户等级(1=A级 2=B级 3=C级 4=D级)</summary>
        [SugarColumn(ColumnName = "customer_level", ColumnDescription = "客户等级", ColumnDataType = "int", IsNullable = false, DefaultValue = "3")]
        public int CustomerLevel { get; set; } = 3;
        ...
        [SugarColumn(ColumnName = "customer_source", ColumnDescription = "客户来源", ColumnDataType = "int", IsNullable = false, DefaultValue = "5")]
        public int CustomerSource { get; set; } = 5;
