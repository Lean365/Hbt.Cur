...
namespace Hbt.Cur.Domain.Entities.Logistics.Sales
{
    ...
    /// 创建时间: 2024-03-07
    /// </remarks>
    [SugarTable("hbt_logistics_sales_order_change_log", "销售订单变更记录表")]
    ...
    public class HbtSalesOrderChangeLog : HbtBaseEntity
    {
        ...
        public HbtSalesOrder? SalesOrder { get; set; }
    }
} 