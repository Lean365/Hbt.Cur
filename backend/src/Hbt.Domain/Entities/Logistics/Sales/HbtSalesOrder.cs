...
namespace Hbt.Cur.Domain.Entities.Logistics.Sales
{
    ...
    /// 创建时间: 2024-03-07
    /// </remarks>
    [SugarTable("hbt_logistics_sales_order", "销售订单主表")]
    ...
    public class HbtSalesOrder : HbtBaseEntity
    {
        ...
        /// 销售订单明细
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtSalesOrderDetail.SalesOrderId))]
        public List<HbtSalesOrderDetail>? OrderDetails { get; set; }
    }
} 