...
using Hbt.Cur.Domain.Entities.Logistics.Material;
...
namespace Hbt.Cur.Domain.Entities.Logistics.Sales
{
    ...
    public class HbtSalesPrice : HbtBaseEntity
    {
        ...
        [Navigate(NavigateType.OneToMany, nameof(HbtSalesPriceScale.PriceCode))]
        public List<HbtSalesPriceScale>? SalesPriceScales { get; set; }
