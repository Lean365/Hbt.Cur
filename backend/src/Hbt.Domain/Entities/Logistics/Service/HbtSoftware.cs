...
namespace Hbt.Domain.Entities.Logistics.Service
{
    ...
    /// 创建时间: 2024-03-07
    /// </remarks>
    [SugarTable("hbt_logistics_service_software_service", "软件服务表")]
    ...
    public class HbtSoftware : HbtBaseEntity
    {
        ...
        /// 软件模块导航属性（一对多）
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtSoftwareModule.SoftwareId))]
        public List<HbtSoftwareModule>? SoftwareModules { get; set; }
