...
namespace Hbt.Domain.Entities.Logistics.Service
{
    ...
    /// 创建时间: 2024-03-07
    /// </remarks>
    [SugarTable("hbt_logistics_service_equipment", "设备表")]
    ...
    public class HbtEquipment : HbtBaseEntity
    {
        ...
        /// 外部设备配件导航属性（一对多）
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtEquipmentAccessory.EquipmentId))]
        public List<HbtEquipmentAccessory>? EquipmentAccessories { get; set; }
    }
} 