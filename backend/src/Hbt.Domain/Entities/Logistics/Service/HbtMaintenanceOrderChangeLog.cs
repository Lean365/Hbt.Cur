...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtMaintenanceOrderChangeLog.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 维修工单变更记录实体类
...
namespace Hbt.Domain.Entities.Logistics.Service
{
    ...
    /// 创建者: Lean365
    /// 创建时间: 2024-03-07
    /// 说明: 记录维修工单的所有变更历史，包括状态变更、内容修改等
    /// </remarks>
    [SugarTable("hbt_logistics_maintenance_order_change_log", "维修工单变更记录表")]
    [SugarIndex("ix_maintenance_order_change_log", nameof(MaintenanceOrderId), OrderByType.Asc, nameof(ChangeTime), OrderByType.Desc, false)]
    [SugarIndex("ix_change_type", nameof(ChangeType), OrderByType.Asc, false)]
    public class HbtMaintenanceOrderChangeLog : HbtBaseEntity
    {
        /// <summary>维修工单ID</summary>
        [SugarColumn(ColumnName = "maintenance_order_id", ColumnDescription = "维修工单ID", ColumnDataType = "bigint", IsNullable = false)]
