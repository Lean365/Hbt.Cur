...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtServiceContractChangeLog.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 服务合同变更记录实体类
...
namespace Hbt.Cur.Domain.Entities.Logistics.Service
{
    ...
    /// 创建时间: 2024-03-07
    /// </remarks>
    [SugarTable("hbt_logistics_service_contract_change_log", "服务合同变更记录表")]
    ...
    public class HbtServiceContractChangeLog : HbtBaseEntity
    {
