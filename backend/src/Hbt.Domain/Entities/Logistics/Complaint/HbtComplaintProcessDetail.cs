...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtComplaintProcessDetail.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
...
namespace Hbt.Domain.Entities.Logistics.Complaint
{
    ...
    /// 参考: SAP QM 质量管理模块
    /// </remarks>
    [SugarTable("hbt_logistics_complaint_process_detail", "客诉处理明细")]
    ...
    public class HbtComplaintProcessDetail : HbtBaseEntity
    {
        /// <summary>
        /// 处理主表ID
        /// </summary>
        ...
        public HbtComplaintProcess? Process { get; set; }
