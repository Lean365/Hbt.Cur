...
namespace Lean.Hbt.Domain.Entities.Accounting.Controlling
{
    /// <summary>
    ...
    /// </remarks>
    [SugarTable("hbt_accounting_controlling_profit_center", "利润中心表")]
    ...
    public class HbtProfitCenter : HbtBaseEntity
    {
        /// <summary>
        /// 公司代码
        /// </summary>
        ...
        /// <summary>
        /// 利润中心类型(1=产品利润中心 2=区域利润中心 3=客户利润中心 4=渠道利润中心 5=其他)
        /// </summary>
        [SugarColumn(ColumnName = "profit_center_type", ColumnDescription = "利润中心类型", ColumnDataType = "int", IsNullable = false)]
        public int ProfitCenterType { get; set; }

        /// <summary>
        /// 利润中心类别
        /// </summary>
        [SugarColumn(ColumnName = "profit_center_category", ColumnDescription = "利润中心类别", Length = 50, ColumnDataType = "nvarchar", IsNullable = true)]
        public string? ProfitCenterCategory { get; set; }
        ...
        public HbtProfitCenter? Parent { get; set; }
        ...
        public HbtCostCenter? CostCenter { get; set; }
        ...
        /// 利润中心启用日期
        /// </summary>
        [SugarColumn(ColumnName = "profit_center_start_date", ColumnDescription = "利润中心启用日期", ColumnDataType = "date", IsNullable = true)]
        public DateTime? ProfitCenterStartDate { get; set; }

        /// <summary>
        /// 利润中心停用日期
        /// </summary>
        [SugarColumn(ColumnName = "profit_center_end_date", ColumnDescription = "利润中心停用日期", ColumnDataType = "date", IsNullable = true)]
