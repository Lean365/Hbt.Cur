...
namespace Lean.Hbt.Domain.Entities.Accounting.Controlling
{
    ...
    /// </remarks>
    [SugarTable("hbt_accounting_controlling_cost_element", "成本要素表")]
    ...
    public class HbtCostElement : HbtBaseEntity
    {
        ...
        /// 成本要素启用日期
        /// </summary>
        [SugarColumn(ColumnName = "cost_element_start_date", ColumnDescription = "成本要素启用日期", ColumnDataType = "date", IsNullable = true)]
        public DateTime? CostElementStartDate { get; set; }

        /// <summary>
        /// 成本要素停用日期
        /// </summary>
        [SugarColumn(ColumnName = "cost_element_end_date", ColumnDescription = "成本要素停用日期", ColumnDataType = "date", IsNullable = true)]
        public DateTime? CostElementEndDate { get; set; }
