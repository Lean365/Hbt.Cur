...
namespace Lean.Hbt.Domain.Entities.Accounting.Financial
{
    ...
    /// </remarks>
    [SugarTable("hbt_accounting_financial_company", "公司信息")]
    ...
    public class HbtCompany : HbtBaseEntity
    {
        ...
        /// 公司成立日期
        /// </summary>
        [SugarColumn(ColumnName = "company_establishment_date", ColumnDescription = "成立日期", ColumnDataType = "date", IsNullable = true)]
