...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtStaffRollingBudget.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V1.0.0
// 描述    : 人员滚动预算实体类 (基于SAP FI人员滚动预算管理)
...
namespace Lean.Hbt.Domain.Entities.Accounting.Budget
{
    ...
    /// 参考: SAP FI-FI 人员预算管理
    /// </remarks>
    [SugarTable("hbt_accounting_budget_staff_rolling_budget", "人员滚动预算表")]
    [SugarIndex("ix_staff_rolling_budget_code", nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(DepartmentCode), OrderByType.Asc, nameof(FiscalYear), OrderByType.Asc, nameof(FiscalPeriod), OrderByType.Asc, true)]
    ...
    public class HbtStaffRollingBudget : HbtBaseEntity
    {
        ...
        /// 原始预算人数
        /// </summary>
        [SugarColumn(ColumnName = "original_budget_headcount", ColumnDescription = "原始预算人数", ColumnDataType = "int", IsNullable = false)]
        public int OriginalBudgetHeadcount { get; set; }

        /// <summary>
        /// 调整后预算人数
        /// </summary>
        [SugarColumn(ColumnName = "adjusted_budget_headcount", ColumnDescription = "调整后预算人数", ColumnDataType = "int", IsNullable = false)]
        public int AdjustedBudgetHeadcount { get; set; }

        /// <summary>
        /// 原始预算人均薪资
        /// </summary>
        [SugarColumn(ColumnName = "original_budget_average_salary", ColumnDescription = "原始预算人均薪资", ColumnDataType = "decimal(18,2)", IsNullable = false)]
        public decimal OriginalBudgetAverageSalary { get; set; }

        /// <summary>
        /// 调整后预算人均薪资
        /// </summary>
        [SugarColumn(ColumnName = "adjusted_budget_average_salary", ColumnDescription = "调整后预算人均薪资", ColumnDataType = "decimal(18,2)", IsNullable = false)]
        public decimal AdjustedBudgetAverageSalary { get; set; }
