...
namespace Lean.Hbt.Domain.Entities.Accounting.Budget
{
    ...
    /// 参考: SAP FI-FI 预算科目管理
    /// </remarks>
    [SugarTable("hbt_accounting_budget_budget_account", "预算科目表")]
    ...
    public class HbtBudgetAccount : HbtBaseEntity
    {
        /// <summary>
        /// 公司代码
        /// </summary>
        ...
        public Financial.HbtCompanyAccount? CompanyAccount { get; set; }
        ...
        public HbtBudgetAccount? ParentBudgetAccount { get; set; }
