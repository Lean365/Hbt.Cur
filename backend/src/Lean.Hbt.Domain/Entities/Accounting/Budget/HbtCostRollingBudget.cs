...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtCostRollingBudget.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 成本滚动预算实体类 (基于SAP CO成本滚动预算管理)
...
namespace Lean.Hbt.Domain.Entities.Accounting.Budget
{
    ...
    /// </remarks>
    [SugarTable("hbt_accounting_budget_cost_rolling_budget", "成本滚动")]
    [SugarIndex("ix_cost_rolling_budget_code", nameof(CompanyCode), OrderByType.Asc, nameof(PlantCode), OrderByType.Asc, nameof(CostCenterCode), OrderByType.Asc, nameof(FiscalYear), OrderByType.Asc, nameof(FiscalPeriod), OrderByType.Asc, true)]
