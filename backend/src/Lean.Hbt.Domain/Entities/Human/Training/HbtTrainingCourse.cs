// -----------------------------------------------------------------------------
// <copyright file="HbtTrainingCourse.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Training;

/// <summary>
/// 培训课程实体
/// </summary>
[SugarTable("hbt_hrm_training_course", "培训课程表")]
[SugarIndex("ix_training_course_code", nameof(CourseCode), OrderByType.Asc, true)]
public class HbtTrainingCourse : HbtBaseEntity
{
    /// <summary>
    /// 课程编码
    /// </summary>
