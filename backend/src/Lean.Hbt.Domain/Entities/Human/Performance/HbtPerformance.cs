// -----------------------------------------------------------------------------
// <copyright file="HbtPerformance.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Performance;

/// <summary>
/// 绩效考核实体
/// </summary>
[SugarTable("hbt_hrm_performance", "绩效考核表")]
[SugarIndex("ix_performance_employee", nameof(EmployeeId), OrderByType.Asc)]
public class HbtPerformance : HbtBaseEntity
{
    /// <summary>
    /// 员工ID
    /// </summary>
