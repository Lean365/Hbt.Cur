// -----------------------------------------------------------------------------
// <copyright file="HbtLeave.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Leave;

/// <summary>
/// 请假记录实体
/// </summary>
[SugarTable("hbt_hrm_leave", "请假记录表")]
...
public class HbtLeave : HbtBaseEntity
{
    /// <summary>
    /// 请假编号
    /// </summary>
