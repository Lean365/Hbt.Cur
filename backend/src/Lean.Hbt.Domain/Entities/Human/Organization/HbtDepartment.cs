// -----------------------------------------------------------------------------
// <copyright file="HbtDepartment.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Organization;
...
/// 3. 关联部门负责人和员工
/// </remarks>
[SugarTable("hbt_hrm_department", "部门表")]
...
public class HbtDepartment : HbtBaseEntity
{
    /// <summary>
    /// 部门编码
    /// </summary>
    ...
    public virtual HbtDepartment? Parent { get; set; }

    /// <summary>
    /// 子部门
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(ParentId))]
    public virtual List<HbtDepartment>? Children { get; set; }

    /// <summary>
    /// 部门负责人
    /// </summary>
    [Navigate(NavigateType.OneToOne, nameof(ManagerId))]
    public virtual Employee.HbtEmployee? Manager { get; set; }

    /// <summary>
    /// 部门员工
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(Employee.HbtEmployee.DepartmentId))]
    public virtual List<Employee.HbtEmployee>? Employees { get; set; }
}
