// -----------------------------------------------------------------------------
// <copyright file="HbtPosition.cs" company="YourCompanyName">
...
/// 3. 关联职位职责和要求
/// </remarks>
[SugarTable("hbt_hrm_position", "职位表")]
...
public class HbtPosition : HbtBaseEntity
{
    /// <summary>
    /// 职位编码
    /// </summary>
    ...
    /// 职位员工
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(Employee.HbtEmployee.PositionId))]
