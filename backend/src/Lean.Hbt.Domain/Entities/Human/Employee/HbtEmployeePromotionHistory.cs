// -----------------------------------------------------------------------------
// <copyright file="HbtEmployeePromotionHistory.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Employee
{
    ...
    /// 3. 为晋升决策提供历史依据
    /// </remarks>
    [SugarTable("hbt_hrm_employee_promotion_history", "员工晋升历史表")]
    ...
    public class HbtEmployeePromotionHistory : HbtBaseEntity
    {
        /// <summary>
        /// 员工ID
        /// </summary>
