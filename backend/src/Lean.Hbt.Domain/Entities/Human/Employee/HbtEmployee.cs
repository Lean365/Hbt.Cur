// -----------------------------------------------------------------------------
// <copyright file="HbtEmployee.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Employee;
...
/// 3. 支持员工状态管理
/// </remarks>
[SugarTable("hbt_hrm_employee", "员工表")]
...
public class HbtEmployee : HbtBaseEntity
{
    /// <summary>
    /// 员工编号
    /// </summary>
    ...
    public virtual Organization.HbtDepartment? Department { get; set; }

    /// <summary>
    /// 职位信息
    /// </summary>
    [Navigate(NavigateType.OneToOne, nameof(PositionId))]
    public virtual Organization.HbtPosition? Position { get; set; }

    /// <summary>
    /// 直属上级
    /// </summary>
    [Navigate(NavigateType.OneToOne, nameof(ManagerId))]
    public virtual HbtEmployee? Manager { get; set; }

    /// <summary>
    /// 下属员工
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(ManagerId))]
    public virtual List<HbtEmployee>? Subordinates { get; set; }

    /// <summary>
    /// 员工合同
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(HbtEmployeeContract.EmployeeId))]
    public virtual List<HbtEmployeeContract>? Contracts { get; set; }

    /// <summary>
    /// 员工薪资
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(Salary.HbtEmployeeSalary.EmployeeId))]
    public virtual List<Salary.HbtEmployeeSalary>? Salaries { get; set; }

    /// <summary>
    /// 考勤记录
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(Attendance.HbtAttendance.EmployeeId))]
    public virtual List<Attendance.HbtAttendance>? Attendances { get; set; }

    /// <summary>
    /// 请假记录
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(Leave.HbtLeave.EmployeeId))]
    public virtual List<Leave.HbtLeave>? Leaves { get; set; }

    /// <summary>
    /// 培训记录
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(Training.HbtTrainingRecord.EmployeeId))]
    public virtual List<Training.HbtTrainingRecord>? TrainingRecords { get; set; }

    /// <summary>
    /// 绩效记录
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(Performance.HbtPerformance.EmployeeId))]
    public virtual List<Performance.HbtPerformance>? Performances { get; set; }
}
