// -----------------------------------------------------------------------------
// <copyright file="HbtEmployeeTransferHistory.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Employee
{
    ...
    /// 3. 为调岗决策提供历史依据
    /// </remarks>
    [SugarTable("hbt_hrm_employee_transfer_history", "员工调岗历史表")]
    ...
    public class HbtEmployeeTransferHistory : HbtBaseEntity
    {
        /// <summary>
        /// 员工ID
        /// </summary>
        ...
        public virtual HbtEmployee? Employee { get; set; }

        /// <summary>
        /// 原部门信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(OriginalDepartmentId))]
        public virtual Organization.HbtDepartment? OriginalDepartment { get; set; }

        /// <summary>
        /// 新部门信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(NewDepartmentId))]
        public virtual Organization.HbtDepartment? NewDepartment { get; set; }

        /// <summary>
        /// 原职位信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(OriginalPositionId))]
        public virtual Organization.HbtPosition? OriginalPosition { get; set; }

        /// <summary>
        /// 新职位信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(NewPositionId))]
        public virtual Organization.HbtPosition? NewPosition { get; set; }

        /// <summary>
        /// 审批人信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(ApproverId))]
        public virtual HbtEmployee? Approver { get; set; }
    }
} 