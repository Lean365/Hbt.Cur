﻿// -----------------------------------------------------------------------------
// <copyright file="HbtJobPosting.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Recruitment
{
    ...
    /// 3. 关联职位和部门信息
    /// </remarks>
    [SugarTable("hbt_hrm_job_posting", "职位发布表")]
    ...
    public class HbtJobPosting : HbtBaseEntity
    {
        /// <summary>
        /// 发布编号
        /// </summary>
        ...
        public virtual Employee.HbtEmployee? Recruiter { get; set; }

        /// <summary>
        /// 应聘者列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtJobApplication.JobPostingId))]
        public virtual List<HbtJobApplication>? Applications { get; set; }
    }
}