﻿// -----------------------------------------------------------------------------
// <copyright file="HbtJobApplication.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Recruitment
{
    ...
    /// 3. 关联职位发布和应聘者信息
    /// </remarks>
    [SugarTable("hbt_hrm_job_application", "招聘申请表")]
    ...
    public class HbtJobApplication : HbtBaseEntity
    {
        /// <summary>
        /// 申请编号
        /// </summary>
        ...
        public virtual HbtJobPosting? JobPosting { get; set; }

        /// <summary>
        /// 应聘者信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(ApplicantId))]
        public virtual Employee.HbtEmployee? Applicant { get; set; }

        /// <summary>
        /// 推荐人信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(ReferrerId))]
        public virtual Employee.HbtEmployee? Referrer { get; set; }
    }
}
