// -----------------------------------------------------------------------------
// <copyright file="HbtPositionApplication.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Recruitment
{
    /// <summary>
    /// 职位申请实体（内部职位调动申请）
    /// </summary>
    ...
    /// 3. 关联员工、原职位、目标职位信息
    /// </remarks>
    [SugarTable("hbt_hrm_position_application", "职位申请表")]
    ...
    public class HbtPositionApplication : HbtBaseEntity
    {
        /// <summary>
        /// 申请编号
        /// </summary>
        ...
        /// 备注
        /// </summary>
        [SugarColumn(ColumnName = "remark", ColumnDescription = "备注", ColumnDataType = "nvarchar", Length = 1000, IsNullable = true)]
        ...
        public virtual Organization.HbtPosition? CurrentPosition { get; set; }

        /// <summary>
        /// 当前部门信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(CurrentDepartmentId))]
        public virtual Organization.HbtDepartment? CurrentDepartment { get; set; }

        /// <summary>
        /// 目标职位信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(TargetPositionId))]
        public virtual Organization.HbtPosition? TargetPosition { get; set; }

        /// <summary>
        /// 目标部门信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(TargetDepartmentId))]
        public virtual Organization.HbtDepartment? TargetDepartment { get; set; }

        /// <summary>
        /// 部门审批人信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(DepartmentApproverId))]
        public virtual Employee.HbtEmployee? DepartmentApprover { get; set; }

        /// <summary>
        /// 人事审批人信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(HrApproverId))]
        public virtual Employee.HbtEmployee? HrApprover { get; set; }

        /// <summary>
        /// 总经理审批人信息
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(GeneralManagerApproverId))]
        public virtual Employee.HbtEmployee? GeneralManagerApprover { get; set; }
    }
} 