// -----------------------------------------------------------------------------
// <copyright file="HbtEmployeeBenefit.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Benefit;

/// <summary>
/// 员工福利实体
/// </summary>
[SugarTable("hbt_hrm_employee_benefit", "员工福利表")]
...
public class HbtEmployeeBenefit : HbtBaseEntity
{
    /// <summary>
    /// 员工ID
    /// </summary>
    ...
    public virtual HbtBenefitItem? BenefitItem { get; set; }
}
