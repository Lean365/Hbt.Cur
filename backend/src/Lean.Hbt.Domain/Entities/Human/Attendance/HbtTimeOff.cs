// -----------------------------------------------------------------------------
// <copyright file="HbtTimeOff.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Human.Attendance;

/// <summary>
/// 调休实体
/// </summary>
[SugarTable("hbt_hrm_time_off", "调休表")]
...
public class HbtTimeOff : HbtBaseEntity
{
    /// <summary>
    /// 调休编号
    /// </summary>
    ...
    public virtual Employee.HbtEmployee? Approver { get; set; }

    /// <summary>
    /// 发布人
    /// </summary>
    [Navigate(NavigateType.OneToOne, nameof(PublisherId))]
    public virtual Employee.HbtEmployee? Publisher { get; set; }

    /// <summary>
    /// 关联加班记录
    /// </summary>
    [Navigate(NavigateType.OneToOne, nameof(OvertimeId))]
    public virtual HbtOvertime? Overtime { get; set; }
}
