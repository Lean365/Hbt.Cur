...
using Lean.Hbt.Domain.Entities.Routine.Quartz;
...
namespace Lean.Hbt.Domain.Entities.Audit
{
    ...
    public class HbtQuartzLog : HbtBaseEntity
    {
        ...
        /// 任务ID（关联HbtQuartz表）
        /// </summary>
        [SugarColumn(ColumnName = "quartz_id", ColumnDescription = "任务ID（关联HbtQuartz表）", IsNullable = false, DefaultValue = "0", ColumnDataType = "bigint", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
        ...
        public HbtQuartz? QuartzTask { get; set; }
    }
}