...
namespace Lean.Hbt.Domain.Entities.Admin
{
    ...
    /// 系统配置实体
    /// </summary>
    [SugarTable("hbt_sys_config", "系统配置表")]
    public class HbtSysConfig : HbtBaseEntity
    {
        /// <summary>
        /// 配置名称
        /// </summary>
        ...
        /// 系统内置（0否 1是）
        /// </summary>
        [SugarColumn(ColumnName = "config_type", ColumnDescription = "系统内置（0否 1是）", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
