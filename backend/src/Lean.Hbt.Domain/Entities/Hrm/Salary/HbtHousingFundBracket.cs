// -----------------------------------------------------------------------------
// <copyright file="HbtHousingFundBracket.cs" company="Hbt365">
...
namespace Lean.Hbt.Domain.Entities.Hrm.Salary;

/// <summary>
/// 住房公积金等级
/// </summary>
[SugarTable("hbt_hrm_housing_fund_bracket", "住房公积金等级表")]
public class HbtHousingFundBracket : HbtBaseEntity
{
    /// <summary>
    /// 等级名称
    /// </summary>
