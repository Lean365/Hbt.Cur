...
namespace Lean.Hbt.Domain.Entities.Identity
{
    ...
    [SugarIndex("ix_tenant_post", $"{nameof(TenantId)},{nameof(PostCode)}", OrderByType.Asc, true)]
    public class HbtPost : HbtBaseEntity
    {
        /// <summary>
        /// 岗位编码
        /// </summary>
        [SugarColumn(ColumnName = "post_code", ColumnDescription = "岗位编码", Length = 50, ColumnDataType = "nvarchar", IsNullable = false)]
        public string PostCode { get; set; }

        /// <summary>
        /// 岗位名称
        /// </summary>
        [SugarColumn(ColumnName = "post_name", ColumnDescription = "岗位名称", Length = 50, ColumnDataType = "nvarchar", IsNullable = false)]
