...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtMedicineDistribution.cs
// 创建者 : Lean365
// 创建时间: 2024-12-01
// 版本号 : V0.0.1
// 描述    : 药品发放主表实体类
...
namespace Lean.Hbt.Domain.Entities.Routine.Medical
{
    /// <summary>
    /// 药品发放主表实体类
    /// </summary>
    ...
    /// </remarks>
    [SugarTable("hbt_routine_medical_medicine_distribution", "药品发放主表")]
    ...
    public class HbtMedicineDistribution : HbtBaseEntity
    {
        ...
        /// 导航属性：关联的就诊记录
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(HbtMedicalVisit.Id))]
        public HbtMedicalVisit? Visit { get; set; }

        /// <summary>
        /// 导航属性：药品发放明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtMedicineDistributionDetail.DistributionId))]
        public List<HbtMedicineDistributionDetail>? DistributionDetails { get; set; }
    }
} 