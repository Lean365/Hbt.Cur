...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtMedicineDistributionDetail.cs
// 创建者 : Lean365
// 创建时间: 2024-12-19
// 版本号 : V1.0.0
// 描述    : 药品发放明细表实体类
...
namespace Lean.Hbt.Domain.Entities.Routine.Medical
{
    ...
    /// </remarks>
    [SugarTable("hbt_routine_medical_medicine_distribution_detail", "药品发放明细")]
    ...
    public class HbtMedicineDistributionDetail : HbtBaseEntity
    {
        ...
        public HbtMedicineDistribution? Distribution { get; set; }

        /// <summary>
        /// 导航属性：关联的药品信息
        /// </summary>
        [Navigate(NavigateType.ManyToOne, nameof(MedicineId))]
        public HbtMedicine? Medicine { get; set; }
    }
} 