...
namespace Lean.Hbt.Domain.Entities.Routine.Medical
{
    ...
    /// </remarks>
    [SugarTable("hbt_routine_medical_visit", "医务就诊记录")]
    ...
    public class HbtMedicalVisit : HbtBaseEntity
    {
        ...
        /// 导航属性：关联的药品发放记录
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(HbtMedicineDistribution.VisitId))]
        public HbtMedicineDistribution? MedicineDistribution { get; set; }
    }
} 