...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtMedicineRequestDetail.cs
// 创建者 : Lean365
// 创建时间: 2024-12-19
// 版本号 : V1.0.0
// 描述    : 药品请购申请明细表实体类
...
namespace Lean.Hbt.Domain.Entities.Routine.MedicalManagement
{
    /// <summary>
    /// 药品请购申请明细表实体类
    /// </summary>
    ...
    /// </remarks>
    [SugarTable("hbt_routine_medical_medicine_purchase_request_detail", "药品请购申请明细")]
    ...
    public class HbtMedicinePurchaseRequestDetail : HbtBaseEntity
    {
