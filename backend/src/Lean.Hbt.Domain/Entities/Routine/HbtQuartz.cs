...
namespace Lean.Hbt.Domain.Entities.Routine
{
    ...
    public class HbtQuartz : HbtBaseEntity
    {
        ...
        /// 是否并发执行
        /// </summary>
        [SugarColumn(ColumnName = "task_concurrent", ColumnDescription = "是否并发执行", IsNullable = false, DefaultValue = "0", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
