...
namespace Lean.Hbt.Domain.Entities.Routine.Document
{
    ...
    /// 创建者: Lean365
    /// 创建时间: 2024-03-07
    /// 说明: 记录ISO文档的签收情况，包括阅读、确认、培训、考试等状态
    /// </remarks>
    [SugarTable("hbt_routine_iso_document_receipt", "ISO文档签收表")]
    [SugarIndex("ix_iso_receipt_document_id", nameof(DocumentId), OrderByType.Asc, false)]
    [SugarIndex("ix_iso_receipt_user_id", nameof(UserId), OrderByType.Asc, false)]
    [SugarIndex("ix_iso_receipt_read_time", nameof(ReadTime), OrderByType.Asc, false)]
    [SugarIndex("ix_iso_receipt_confirm_time", nameof(ConfirmTime), OrderByType.Asc, false)]
    [SugarIndex("ix_iso_receipt_training_time", nameof(TrainingTime), OrderByType.Asc, false)]
    public class HbtIsoDocumentReceipt : HbtBaseEntity
    {
        ...
        public HbtIsoDocument? Document { get; set; }
    }
} 