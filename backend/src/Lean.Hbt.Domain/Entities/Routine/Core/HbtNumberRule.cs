...
namespace Lean.Hbt.Domain.Entities.Routine.Core
{
    /// <summary>
    /// 规则实体类
    /// </summary>
    ...
    /// </remarks>
    [SugarTable("hbt_routine_core_number_rule", "单号规则")]
    ...
    public class HbtNumberRule : HbtBaseEntity
    {
        ...
        [SugarColumn(ColumnName = "number_rule_type", ColumnDescription = "规则类型", ColumnDataType = "int", IsNullable = false, DefaultValue = "1")]
        ...
        /// <summary>前缀</summary>
        [SugarColumn(ColumnName = "number_prefix", ColumnDescription = "前缀", Length = 20, ColumnDataType = "nvarchar", IsNullable = true)]
        ...
        [SugarColumn(ColumnName = "include_user_code", ColumnDescription = "是否包含用户代码", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
