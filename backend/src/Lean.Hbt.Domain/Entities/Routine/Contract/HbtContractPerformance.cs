...
namespace Lean.Hbt.Domain.Entities.Routine.Contract
{
    /// <summary>
    /// 合同履约实体类
    /// </summary>
    ...
    /// </remarks>
    [SugarTable("hbt_routine_contract_performance", "合同履约表")]
    ...
    public class HbtContractPerformance : HbtBaseEntity
    {
