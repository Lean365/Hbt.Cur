...
namespace Lean.Hbt.Domain.Entities.Routine.News
{
    ...
    /// 新闻话题关联实体
    /// </summary>
    [SugarTable("hbt_routine_news_topic_relation", "新闻话题关联")]
    public class HbtNewsTopicRelation : HbtBaseEntity
    {
        /// <summary>
        /// 新闻ID。关联的新闻ID。
        /// </summary>
        ...
        public HbtNewsTopic? Topic { get; set; }
    }
} 