...
namespace Lean.Hbt.Domain.Entities.Routine.News
{
    ...
    /// 新闻话题实体
    /// </summary>
    [SugarTable("hbt_routine_news_topic", "新闻话题")]
    public class HbtNewsTopic : HbtBaseEntity
    {
        /// <summary>
        /// 话题名称。话题的标题，用于展示和识别。
        /// </summary>
        ...
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtNewsTopicRelation.TopicId))]
        public List<HbtNewsTopicRelation>? TopicNewsRelations { get; set; }

        /// <summary>
        /// 话题参与者列表。参与该话题的用户记录。
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtNewsTopicParticipant.TopicId))]
        public List<HbtNewsTopicParticipant>? TopicParticipants { get; set; }
    }
} 