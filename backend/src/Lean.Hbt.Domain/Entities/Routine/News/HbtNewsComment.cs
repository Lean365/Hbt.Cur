...
namespace Lean.Hbt.Domain.Entities.Routine.News
{
    ...
    /// 新闻评论实体
    /// </summary>
    [SugarTable("hbt_routine_news_comment", "新闻评论")]
    public class HbtNewsComment : HbtBaseEntity
    {
        /// <summary>
        /// 新闻ID。新闻的唯一标识。
        /// </summary>
        ...
        /// 审核人。审核评论的责任编辑姓名。
        /// </summary>
        [SugarColumn(ColumnName = "auditor_by", ColumnDescription = "审核人", Length = 50, IsNullable = true, ColumnDataType = "nvarchar")]
        ...
        /// 审核备注。审核时的备注信息。
        /// </summary>
        [SugarColumn(ColumnName = "audit_remark", ColumnDescription = "审核备注", Length = 500, IsNullable = true, ColumnDataType = "nvarchar")]
        ...
        public HbtNews? News { get; set; }

        /// <summary>
        /// 父评论。评论的父级评论，用于实现评论回复功能。
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(ParentCommentId))]
        public HbtNewsComment? ParentComment { get; set; }

        /// <summary>
        /// 子评论列表。评论的子级评论列表。
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(ParentCommentId))]
        public List<HbtNewsComment>? ChildComments { get; set; }

        /// <summary>
        /// 评论点赞列表。评论被点赞的记录列表。
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtNewsCommentLike.CommentId))]
        public List<HbtNewsCommentLike>? CommentLikes { get; set; }
    }
}