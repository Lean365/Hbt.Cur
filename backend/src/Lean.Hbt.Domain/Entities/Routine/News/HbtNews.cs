...
namespace Lean.Hbt.Domain.Entities.Routine.News
{
    /// <summary>
    /// 新闻实体
    /// </summary>
    [SugarTable("hbt_routine_news", "新闻")]
    public class HbtNews : HbtBaseEntity
    {
        /// <summary>
        ...
        /// 审核人。审核新闻的用户名称。
        /// </summary>
        [SugarColumn(ColumnName = "news_auditor_by", ColumnDescription = "审核人", Length = 50, IsNullable = true, ColumnDataType = "nvarchar")]
        public string? NewsAuditorBy { get; set; }

        /// <summary>
        /// 审核时间。新闻被审核的时间。
        /// </summary>
        [SugarColumn(ColumnName = "news_audit_time", ColumnDescription = "审核时间", ColumnDataType = "datetime", IsNullable = true)]
        public DateTime? NewsAuditTime { get; set; }
        ...
        /// 审核意见。审核人对新闻的备注或说明。
        /// </summary>
        [SugarColumn(ColumnName = "news_audit_remark", ColumnDescription = "审核意见", Length = 500, IsNullable = true, ColumnDataType = "nvarchar")]
        public string? NewsAuditRemark { get; set; }
        ...
        /// 新闻评论列表。该新闻下的所有评论集合。
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtNewsComment.NewsId))]
        public List<HbtNewsComment>? NewsComments { get; set; }

        /// <summary>
        /// 新闻点赞列表。该新闻下的所有点赞记录集合。
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtNewsLike.NewsId))]
        public List<HbtNewsLike>? NewsLikes { get; set; }

        /// <summary>
        /// 新闻话题关联列表。该新闻关联的所有话题记录。
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtNewsTopicRelation.NewsId))]
        public List<HbtNewsTopicRelation>? NewsTopicRelations { get; set; }
    }
}