...
namespace Lean.Hbt.Domain.Entities.Routine.News
{
    ...
    /// 新闻评论点赞实体
    /// </summary>
    [SugarTable("hbt_routine_news_comment_like", "新闻评论点赞")]
    public class HbtNewsCommentLike : HbtBaseEntity
    {
        /// <summary>
        /// 新闻ID
        /// </summary>
        ...
        /// 评论ID
        /// </summary>
        [SugarColumn(ColumnName = "comment_id", ColumnDescription = "评论ID", IsNullable = false, ColumnDataType = "bigint")]
        ...
        public HbtNewsComment? Comment { get; set; }
    }
} 