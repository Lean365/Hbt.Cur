...
namespace Lean.Hbt.Domain.Entities.Routine.Quartz
{
    /// <summary>
    /// 定时任务实体
    /// </summary>
    ...
    public class HbtQuartz : HbtBaseEntity
    {
        /// <summary>
        /// 任务名称
        /// </summary>
        ...
        /// </summary>
        [SugarColumn(ColumnName = "quartz_type", ColumnDescription = "任务类型（1.程序集 2.网络请求 3.SQL语句）", IsNullable = false, DefaultValue = "1", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
        ...
        /// </summary>
        [SugarColumn(ColumnName = "quartz_trigger_type", ColumnDescription = "触发器类型（0.simple 1.cron）", IsNullable = false, DefaultValue = "1", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
        ...
        /// 状态（0停用 1启用）
        /// </summary>
        [SugarColumn(ColumnName = "status", ColumnDescription = "状态（0停用 1启用）", IsNullable = false, DefaultValue = "0", ColumnDataType = "int", IsOnlyIgnoreUpdate = false, IsOnlyIgnoreInsert = false)]
        ...
        [Navigate(NavigateType.OneToMany, nameof(Lean.Hbt.Domain.Entities.Audit.HbtQuartzLog.QuartzId))]
        public List<Lean.Hbt.Domain.Entities.Audit.HbtQuartzLog>? QuartzLogs { get; set; }
    }
}