...
namespace Lean.Hbt.Domain.Entities.Logistics.Service
{
    ...
    /// 创建时间: 2024-03-07
    /// </remarks>
    [SugarTable("hbt_logistics_service_software_module", "软件模块表")]
    ...
    public class HbtSoftwareModule : HbtBaseEntity
    {
        ...
        public HbtSoftware? Software { get; set; }
    }
} 