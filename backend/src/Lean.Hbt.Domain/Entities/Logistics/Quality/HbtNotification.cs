...
namespace Lean.Hbt.Domain.Entities.Logistics.Quality
{
    ...
    /// 质量通知
    /// </summary>
    [SugarTable("hbt_logistics_quality_notification", "质量通知表")]
    [SugarIndex("ix_quality_notification_code", nameof(Qmnum), OrderByType.Asc, true)]
    public class HbtNotification : HbtBaseEntity
    {
        /// <summary>集团</summary>
        [SugarColumn(ColumnName = "mandt", ColumnDescription = "集团", Length = 6, ColumnDataType = "nvarchar", IsNullable = false)]
        public string? Mandt { get; set; }
        /// <summary>质量通知编号</summary>
        [SugarColumn(ColumnName = "qmnum", ColumnDescription = "质量通知编号", Length = 20, ColumnDataType = "nvarchar", IsNullable = false)]
        public string? Qmnum { get; set; }
        /// <summary>质量通知类型</summary>
        [SugarColumn(ColumnName = "qmart", ColumnDescription = "质量通知类型", Length = 8, ColumnDataType = "nvarchar", IsNullable = true)]
