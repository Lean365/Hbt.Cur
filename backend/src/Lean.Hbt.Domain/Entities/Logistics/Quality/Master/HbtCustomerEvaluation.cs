...
namespace Lean.Hbt.Domain.Entities.Logistics.Quality.Master
{
    /// <summary>
    /// 客户评价实体
    /// </summary>
    [SugarTable("hbt_logistics_quality_customer_evaluation", "顾客评价")]
    public class HbtCustomerEvaluation : HbtBaseEntity
    {
        /// <summary>
        /// 客户ID
        /// </summary>
        [SugarColumn(ColumnName = "customer_id", ColumnDescription = "客户ID", Length = 50, ColumnDataType = "nvarchar", IsNullable = false)]
