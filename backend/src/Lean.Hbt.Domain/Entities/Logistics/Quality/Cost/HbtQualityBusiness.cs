...
namespace Lean.Hbt.Domain.Entities.Logistics.Quality.Cost
{
    /// <summary>
    /// 品质业务主表实体类
    /// </summary>
    ...
    /// </remarks>
    [SugarTable("hbt_logistics_quality_business", "品质业务主表")]
    ...
    public class HbtQualityBusiness : HbtBaseEntity
    {
        ...
        [Navigate(NavigateType.OneToMany, nameof(HbtQualityBusinessIqcCost.QualityBusinessId))]
        public List<HbtQualityBusinessIqcCost>? IqcCosts { get; set; }

        /// <summary>FQC成本列表</summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtQualityBusinessFqcCost.QualityBusinessId))]
        public List<HbtQualityBusinessFqcCost>? FqcCosts { get; set; }

        /// <summary>返工调查列表</summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtReworkInvestigation.QualityBusinessId))]
        public List<HbtReworkInvestigation>? ReworkInvestigations { get; set; }

        /// <summary>不良改修对应对策成本列表</summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtReworkCountermeasure.QualityBusinessId))]
        public List<HbtReworkCountermeasure>? ReworkDefectRepairs { get; set; }

        /// <summary>PCBA成本列表</summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtReworkPcbaCost.QualityBusinessId))]
        public List<HbtReworkPcbaCost>? ReworkPcbaCosts { get; set; }

        /// <summary>组立Assy成本列表</summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtReworkAssemblyCost.QualityBusinessId))]
        public List<HbtReworkAssemblyCost>? ReworkAssemblyCosts { get; set; }

        /// <summary>废弃事故成本列表</summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtScrapAccidentCost.QualityBusinessId))]
        public List<HbtScrapAccidentCost>? ScrapAccidentCosts { get; set; }
