...
namespace Lean.Hbt.Domain.Entities.Logistics.Quality.Cost
{
    ...
    /// 创建者: Lean365
    /// 创建时间: 2024-03-07
    /// 说明: 记录PCBA相关的选别改修成本，包括不良内容、选别改修费用、顾客费用请求等
    /// </remarks>
    [SugarTable("hbt_logistics_quality_rework_pcba_cost", "PCBA成本表")]
    [SugarIndex("ix_quality_business_pcba_cost", nameof(QualityBusinessId), OrderByType.Asc, false)]
    public class HbtReworkPcbaCost : HbtBaseEntity
    {
