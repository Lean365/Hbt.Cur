...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtReworkCountermeasure.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : 对策成本实体类
...
namespace Lean.Hbt.Domain.Entities.Logistics.Quality.Cost
{
    ...
    /// 创建者: Lean365
    /// 创建时间: 2024-03-07
    /// 说明: 记录对策成本，包括不良内容、选别改修费用、顾客费用请求等
    /// </remarks>
    [SugarTable("hbt_logistics_quality_rework_countermeasure", "对策成本表")]
    [SugarIndex("ix_quality_business_countermeasure", nameof(QualityBusinessId), OrderByType.Asc, false)]
    public class HbtReworkCountermeasure : HbtBaseEntity
    {
