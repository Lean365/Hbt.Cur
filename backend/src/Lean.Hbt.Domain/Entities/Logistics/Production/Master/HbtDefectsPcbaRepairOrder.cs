...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtDefectsPcbaRepairOrder.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V1.0.0
// 描述    : PCBA Repair工单组立不良统计实体类
...
{
    /// <summary>
    /// PCBA Repair工单组立不良统计实体类
    /// </summary>
    /// <remarks>
    /// 创建者: Lean365
    /// 创建时间: 2024-03-07
    /// 参考: PCBA Repair工单组立不良统计管理
    /// </remarks>
    [SugarTable("hbt_logistics_pcba_repair_defects_order", "PCBA Repair工单组立不良统计表")]
    ...
    public class HbtDefectsPcbaRepairOrder : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
