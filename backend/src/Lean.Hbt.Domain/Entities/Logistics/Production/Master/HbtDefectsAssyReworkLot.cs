...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtDefectsAssyReworkLot.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V1.0.0
// 描述    : Rework批次组立不良统计实体类
...
namespace Lean.Hbt.Domain.Entities.Logistics.Production
{
    ...
    /// 参考: Rework批次组立不良统计管理
    /// </remarks>
    [SugarTable("hbt_logistics_assy_rework_defects_lot", "Rework批次组立不良统计表")]
    ...
    public class HbtDefectsAssyReworkLot : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
