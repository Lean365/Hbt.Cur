...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA手插输出管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_mp_mir_output", "PCBA 本产手插产出")]
    ...
    public class HbtPcbaMpMirOutput : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// 手插数量
        /// </summary>
        [SugarColumn(ColumnName = "mir_qty", ColumnDescription = "手插数量", ColumnDataType = "decimal", Length = 18, DecimalDigits = 1, IsNullable = false, DefaultValue = "0")]
        public decimal MirQty { get; set; } = 0;
        ...
        /// PCBA手插输出明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtPcbaMpMirOutputDetail.PcbaMpMirOutputId))]
        public List<HbtPcbaMpMirOutputDetail>? PcbaMpMirOutputDetails { get; set; }
    }
} 