...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtPcbaEppSmtDailyDetail.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V0.0.1
// 描述    : PCBA SMT EPP明细实体类
...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA SMT EPP明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_epp_smt_output_detail", "PCBA SMT EPP产出明细表")]
    [SugarIndex("ix_pcba_epp_smt_output_id", nameof(PcbaEppSmtOutputId), OrderByType.Asc, false)]
    public class HbtPcbaEppSmtOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// PCBA SMT EPP输出ID
        /// </summary>
        [SugarColumn(ColumnName = "pcba_epp_smt_output_id", ColumnDescription = "PCBA SMT EPP输出ID", ColumnDataType = "bigint", IsNullable = false)]
        public long PcbaEppSmtOutputId { get; set; }
        ...
        /// PCBA SMT EPP日报
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(PcbaEppSmtOutputId))]
        public HbtPcbaEppSmtOutput? PcbaEppSmtOutput { get; set; }
    }
} 