...
//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtPcbaReworkDailyDetail.cs
// 创建者 : Lean365
// 创建时间: 2024-03-07
// 版本号 : V1.0.0
// 描述    : PCBA返工明细实体类
...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA返工明细管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_rework_output_detail", "PCBA返工明细表")]
    [SugarIndex("ix_pcba_rework_output_id", nameof(PcbaReworkOutputId), OrderByType.Asc, false)]
    [SugarIndex("ix_hour_no", nameof(HourNo), OrderByType.Asc, false)]
    public class HbtPcbaReworkOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// PCBA返工日报ID
        /// </summary>
        [SugarColumn(ColumnName = "pcba_rework_output_id", ColumnDescription = "PCBA返工日报ID", ColumnDataType = "bigint", IsNullable = false)]
        public long PcbaReworkOutputId { get; set; }
        ...
        /// PCBA返工日报
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(PcbaReworkOutputId))]
        public HbtPcbaReworkOutput? PcbaReworkOutput { get; set; }
    }
} 