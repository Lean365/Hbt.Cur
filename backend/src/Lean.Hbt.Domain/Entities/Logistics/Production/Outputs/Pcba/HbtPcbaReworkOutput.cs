...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA返工日报管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_rework_output", "PCBA返工日报表")]
    ...
    public class HbtPcbaReworkOutput : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// PCBA返工明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtPcbaReworkOutputDetail.PcbaReworkOutputId))]
        public List<HbtPcbaReworkOutputDetail>? PcbaReworkOutputDetails { get; set; }
    }
} 