...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA生产日报管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_output", "PCBA日报表")]
    ...
    public class HbtPcbaOutput : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// PCBA明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtPcbaOutputDetail.PcbaOutputId))]
        public List<HbtPcbaOutputDetail>? PcbaOutputDetails { get; set; }
    }
} 