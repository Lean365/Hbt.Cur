...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA自插EPP日报管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_epp_ai_output", "PCBA自插EPP产出")]
    ...
    public class HbtPcbaEppAiOutput : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// PCBA自插EPP明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtPcbaEppAiOutputDetail.PcbaEppAiOutputId))]
        public List<HbtPcbaEppAiOutputDetail>? PcbaEppAiOutputDetails { get; set; }
    }
} 