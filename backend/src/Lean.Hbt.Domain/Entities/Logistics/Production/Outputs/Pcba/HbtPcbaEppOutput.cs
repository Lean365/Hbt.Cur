...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Pcba
{
    ...
    /// 参考: PCBA EPP日报管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_pcba_epp_output", "PCBA EPP日报表")]
    ...
    public class HbtPcbaEppOutput : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// PCBA EPP明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtPcbaEppOutputDetail.PcbaEppOutputId))]
        public List<HbtPcbaEppOutputDetail>? PcbaEppOutputDetails { get; set; }
    }
} 