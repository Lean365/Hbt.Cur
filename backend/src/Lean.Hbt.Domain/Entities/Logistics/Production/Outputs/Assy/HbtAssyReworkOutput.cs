...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Assy
{
    ...
    public class HbtAssyReworkOutput : HbtBaseEntity
    {
        ...
        /// 组立返工明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtAssyReworkOutputDetail.AssyReworkOutputId))]
        public List<HbtAssyReworkOutputDetail>? AssyReworkOutputDetails { get; set; }
    }
} 