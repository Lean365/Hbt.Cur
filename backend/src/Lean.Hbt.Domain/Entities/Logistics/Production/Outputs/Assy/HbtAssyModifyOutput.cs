...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Assy
{
    ...
    public class HbtAssyModifyOutput : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// 组立改修明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtAssyModifyOutputDetail.AssyModifyOutputId))]
        public List<HbtAssyModifyOutputDetail>? AssyModifyOutputDetails { get; set; }
    }
} 