...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Assy
{
    ...
    /// 参考: 组立生产日报管理
    /// </remarks>
    [SugarTable("hbt_logistics_production_assy_output", "组立")]
    ...
    public class HbtAssyOutput : HbtBaseEntity
    {
        /// <summary>
        /// 工厂代码
        /// </summary>
        ...
        /// 组立明细列表
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtAssyOutputDetail.AssyOutputId))]
        public List<HbtAssyOutputDetail>? AssyOutputDetails { get; set; }
    }
} 