...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Outputs.Assy
{
    ...
    [SugarIndex("ix_assy_modify_output_id", nameof(AssyModifyOutputId), OrderByType.Asc, false)]
    [SugarIndex("ix_hour_no", nameof(HourNo), OrderByType.Asc, false)]
    public class HbtAssyModifyOutputDetail : HbtBaseEntity
    {
        /// <summary>
        /// 组立改修日报ID
        /// </summary>
        [SugarColumn(ColumnName = "assy_modify_output_id", ColumnDescription = "组立改修ID", ColumnDataType = "bigint", IsNullable = false)]
        public long AssyModifyOutputId { get; set; }
        ...
        /// 组立改修日报
        /// </summary>
        [Navigate(NavigateType.OneToOne, nameof(AssyModifyOutputId))]
        public HbtAssyModifyOutput? AssyModifyOutput { get; set; }
    }
} 