...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Change
{
    /// <summary>
    /// 设计变更计执行明细表
    /// </summary>
    [SugarTable("hbt_logistics_change_execution_detail", "设变执行明细")]
    public class HbtDesignChangeExecutionDetail : HbtBaseEntity
    {
        /// <summary>
        /// 设计变更号码
        /// </summary>
        ...
        /// 跟踪记录集合
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtChangeExecutionTrack.ChangeNumber))]
        public List<HbtChangeExecutionTrack>? Tracks { get; set; }
    }
} 