...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Change
{
    ...
    /// 设计变更计执行主表
    /// </summary>
    [SugarTable("hbt_logistics_change_execution", "设变执行")]
    public class HbtDesignChangeExecution : HbtBaseEntity
    {
        /// <summary>
        /// 发行日期
        /// </summary>
        ...
        /// 设计变更明细集合
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtDesignChangeExecutionDetail.ChangeNumber))]
        public List<HbtDesignChangeExecutionDetail>? Details { get; set; }
