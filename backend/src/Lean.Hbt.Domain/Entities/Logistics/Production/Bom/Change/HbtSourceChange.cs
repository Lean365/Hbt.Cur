...
namespace Lean.Hbt.Domain.Entities.Logistics.Production.Change
{
    ...
    /// 源设变实体类
    /// </summary>
    [SugarTable("hbt_logistics_source_change", "源设变")]
    [SugarIndex("ix_change_number", nameof(ChangeNumber), OrderByType.Asc, false)]
    public class HbtSourceChange : HbtBaseEntity
    {
        /// <summary>
        /// 设变号码
        /// </summary>
        ...
        /// 设变明细集合
        /// </summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtSourceChangeDetail.ChangeNumber))]
        public List<HbtSourceChangeDetail>? Details { get; set; }
    }
} 