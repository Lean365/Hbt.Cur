...
namespace Lean.Hbt.Domain.Entities.Logistics.Complaint
{
    ...
    /// 参考: SAP QM 质量管理模块
    /// </remarks>
    [SugarTable("hbt_logistics_complaint_detail", "核心客诉明细")]
    ...
    public class HbtComplaintDetail : HbtBaseEntity
    {
        /// <summary>
        /// 客诉主表ID
        /// </summary>
        ...
        public HbtComplaint? Complaint { get; set; }
