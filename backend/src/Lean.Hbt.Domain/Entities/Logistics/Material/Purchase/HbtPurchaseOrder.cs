...
namespace Lean.Hbt.Domain.Entities.Logistics.Material.Purchase
{
    /// <summary>
    /// 采购订单主表实体类
    /// </summary>
    [SugarTable("hbt_logistics_purchase_order", "采购订单主表")]
    ...
    public class HbtPurchaseOrder : HbtBaseEntity
    {
        ...
        [SugarColumn(ColumnName = "order_remark", ColumnDescription = "订单备注", Length = 500, ColumnDataType = "nvarchar", IsNullable = true)]
        ...
        [Navigate(NavigateType.OneToMany, nameof(HbtPurchaseOrderDetail.PurchaseOrderCode))]
        public List<HbtPurchaseOrderDetail>? PurchaseOrderDetails { get; set; }

        /// <summary>供应商信息</summary>
        [Navigate(NavigateType.ManyToOne, nameof(SupplierCode))]
        public HbtSupplier? Supplier { get; set; }
    }
} 