...
namespace Lean.Hbt.Domain.Entities.Logistics.Material.Purchase
{
    ...
    public class HbtPurchasePrice : HbtBaseEntity
    {
        ...
        [Navigate(NavigateType.OneToMany, nameof(HbtPurchasePriceScale.InfoRecordNumber))]
        public List<HbtPurchasePriceScale>? PurchasePriceScales { get; set; }

        /// <summary>采购价格变更记录</summary>
        [Navigate(NavigateType.OneToMany, nameof(HbtPurchasePriceChangeLog.InfoRecordNumber))]
        public List<HbtPurchasePriceChangeLog>? PurchasePriceChangeLogs { get; set; }
