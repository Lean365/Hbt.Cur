...
namespace Lean.Hbt.Domain.Entities.Logistics.Material.Purchase
{
    ...
    /// 采购订单明细表实体类
    /// </summary>
    [SugarTable("hbt_logistics_purchase_order_detail", "采购订单明细表")]
    ...
    public class HbtPurchaseOrderDetail : HbtBaseEntity
    {
        ...
        /// <summary>行项目备注</summary>
        [SugarColumn(ColumnName = "line_remark", ColumnDescription = "行项目备注", Length = 500, ColumnDataType = "nvarchar", IsNullable = true)]
        public string? LineRemark { get; set; }

        /// <summary>采购订单主表</summary>
        [Navigate(NavigateType.ManyToOne, nameof(PurchaseOrderCode))]
        public HbtPurchaseOrder? PurchaseOrder { get; set; }
    }
} 