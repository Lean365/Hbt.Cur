...
namespace Lean.Hbt.Domain.Entities.Logistics.Material.Purchase
{
    ...
    /// 采购价格变更记录表实体类
    /// </summary>
    [SugarTable("hbt_logistics_purchase_price_change_log", "采购价格变更记录表")]
    ...
    public class HbtPurchasePriceChangeLog : HbtBaseEntity
    {
        ...
        public HbtPurchasePrice? PurchasePrice { get; set; }
