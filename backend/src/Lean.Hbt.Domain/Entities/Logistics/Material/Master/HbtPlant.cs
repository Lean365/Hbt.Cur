...
namespace Lean.Hbt.Domain.Entities.Logistics.Material
{
    ...
    /// 参考: SAP MM 物料管理模块
    /// </remarks>
    [SugarTable("hbt_logistics_plant", "工厂信息")]
    ...
    public class HbtPlant : HbtBaseEntity
    {
        ...
        /// 工厂启用日期
        /// </summary>
        [SugarColumn(ColumnName = "plant_start_date", ColumnDescription = "工厂启用日期", ColumnDataType = "date", IsNullable = true)]
        public DateTime? PlantStartDate { get; set; }

        /// <summary>
        /// 工厂停用日期
        /// </summary>
        [SugarColumn(ColumnName = "plant_end_date", ColumnDescription = "工厂停用日期", ColumnDataType = "date", IsNullable = true)]
