namespace Lean.Hbt.Domain.Entities.Finance.Budget
{
    ...
    /// 模具滚动预算表
    /// </summary>
    [SugarTable("hbt_budget_mould_rolling", "模具滚动预算表")]
    [SugarIndex("ix_mould_rolling_budget_year_month", nameof(BudgetYear), OrderByType.Asc, nameof(BudgetMonth), OrderByType.Asc, true)]
