namespace Lean.Hbt.Domain.Entities.Finance.Budget
{
    ...
    /// 固定资产滚动预算表
    /// </summary>
    [SugarTable("hbt_budget_fixed_asset_rolling", "固定资产滚动预算表")]
    [SugarIndex("ix_fixed_asset_rolling_budget_year_month", nameof(BudgetYear), OrderByType.Asc, nameof(BudgetMonth), OrderByType.Asc, true)]
