...
namespace Lean.Hbt.Domain.Entities.Workflow
{
    ...
    public class HbtScheduledTask : HbtBaseEntity
    {
        /// <summary>
        /// 工作流实例ID
        /// </summary>
        ...
        /// </summary>
        [SugarColumn(ColumnName = "status", ColumnDescription = "执行状态", ColumnDataType = "int", IsNullable = false, DefaultValue = "0")]
        ...
        /// 任务参数(JSON格式)
        /// </summary>
        [SugarColumn(ColumnName = "task_parameters", ColumnDescription = "任务参数", ColumnDataType = "text", IsNullable = true)]
