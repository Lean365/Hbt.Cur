...
namespace Lean.Hbt.WebApi.Middlewares
{
    ...
    /// 中间件扩展方法
    /// </summary>
    public static class HbtCaseSensitiveRouteMiddlewareExtensions
    {
        public static IApplicationBuilder UseHbtCaseSensitiveRoute(this IApplicationBuilder builder)
        {
