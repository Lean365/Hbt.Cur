...
namespace Lean.Hbt.WebApi.Controllers.Routine
{
    ...
    public class HbtContractController : HbtBaseController
    {
        private readonly IHbtContractService _contractService;
        ...
        public HbtContractController(
            IHbtContractService contractService,
            IHbtLogger logger,
        ...
        [HttpGet("list")]
        [HbtPerm("routine:contract:list")]
        public async Task<IActionResult> GetListAsync([FromQuery] HbtContractQueryDto query)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] HbtContractCreateDto input)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateAsync([FromBody] HbtContractUpdateDto input)
        {
        ...
        public async Task<IActionResult> ExportAsync([FromQuery] HbtContractQueryDto query, [FromQuery] string sheetName = "合同信息")
        {
