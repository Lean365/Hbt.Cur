...
namespace Lean.Hbt.WebApi.Controllers.Routine
{
    ...
    public class HbtProjectController : HbtBaseController
    {
        private readonly IHbtProjectService _projectService;
        ...
        public HbtProjectController(
            IHbtProjectService projectService,
            IHbtLogger logger,
        ...
        [HttpGet("list")]
        [HbtPerm("routine:project:list")]
        public async Task<IActionResult> GetListAsync([FromQuery] HbtProjectQueryDto query)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] HbtProjectCreateDto input)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateAsync([FromBody] HbtProjectUpdateDto input)
        {
        ...
        public async Task<IActionResult> ExportAsync([FromQuery] HbtProjectQueryDto query, [FromQuery] string sheetName = "项目信息")
        {
