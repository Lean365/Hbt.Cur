...
namespace Lean.Hbt.WebApi.Controllers.Routine
{
    ...
    public class HbtMeetingController : HbtBaseController
    {
        private readonly IHbtMeetingService _meetingService;
        ...
        public HbtMeetingController(
            IHbtMeetingService meetingService,
            IHbtLogger logger,
        ...
        [HttpGet("list")]
        [HbtPerm("routine:meeting:list")]
        public async Task<IActionResult> GetListAsync([FromQuery] HbtMeetingQueryDto query)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] HbtMeetingCreateDto input)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateAsync([FromBody] HbtMeetingUpdateDto input)
        {
        ...
        public async Task<IActionResult> ExportAsync([FromQuery] HbtMeetingQueryDto query, [FromQuery] string sheetName = "会议信息")
        {
