//===================================================================
// 项目名 : Lean.Hbt
// 文件名 : HbtNewsTopicParticipantController.cs
// 创建者 : Claude
// 创建时间: 2024-12-01
// 版本号 : V0.0.1
// 描述   : 新闻话题参与者控制器
...
using Lean.Hbt.Application.Dtos.Routine.News;
using Lean.Hbt.Application.Services.Routine.News;

namespace Lean.Hbt.WebApi.Controllers.Routine.News
{
    /// <summary>
    /// 新闻话题参与者控制器
    /// </summary>
    ...
    public class HbtNewsTopicParticipantController : HbtBaseController
    {
        private readonly IHbtNewsTopicParticipantService _participantService;
        ...
        public HbtNewsTopicParticipantController(
            IHbtNewsTopicParticipantService participantService,
            IHbtLogger logger,
        ...
        [HttpGet("list")]
        [HbtPerm("routine:news:topic-participant:list")]
        public async Task<IActionResult> GetListAsync([FromQuery] HbtNewsTopicParticipantQueryDto query)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] HbtNewsTopicParticipantCreateDto input)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateAsync([FromBody] HbtNewsTopicParticipantUpdateDto input)
        {
        ...
        /// <returns>是否成功</returns>
        [HttpPut("status")]
        public async Task<IActionResult> UpdateStatusAsync([FromBody] HbtNewsTopicParticipantStatusDto input)
        {
