...
namespace Lean.Hbt.WebApi.Controllers.Routine.News
{
    ...
    public class HbtNewsTopicController : HbtBaseController
    {
        private readonly IHbtNewsTopicService _topicService;
        ...
        public HbtNewsTopicController(
            IHbtNewsTopicService topicService,
            IHbtLogger logger,
        ...
        [HttpGet("list")]
        [HbtPerm("routine:news:topic:list")]
        public async Task<IActionResult> GetListAsync([FromQuery] HbtNewsTopicQueryDto query)
        {
        ...
        [HttpGet("{id}")]
        [HbtPerm("routine:news:topic:query")]
        ...
        [HttpPost]
        [HbtLog("创建新闻话题")]
        [HbtPerm("routine:news:topic:create")]
        public async Task<IActionResult> CreateAsync([FromBody] HbtNewsTopicCreateDto input)
        {
        ...
        [HttpPut]
        [HbtLog("更新新闻话题")]
        [HbtPerm("routine:news:topic:update")]
        public async Task<IActionResult> UpdateAsync([FromBody] HbtNewsTopicUpdateDto input)
        {
        ...
        [HttpDelete("{id}")]
        [HbtLog("删除新闻话题")]
        [HbtPerm("routine:news:topic:delete")]
        ...
        [HbtLog("更新话题状态")]
        [HbtPerm("routine:news:topic:update")]
        public async Task<IActionResult> UpdateStatusAsync([FromBody] HbtNewsTopicStatusDto input)
        {
        ...
        [HbtLog("用户参与话题")]
        [HbtPerm("routine:news:topic:join")]
