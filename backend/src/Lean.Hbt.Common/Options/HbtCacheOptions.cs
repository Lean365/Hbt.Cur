...
namespace Lean.Hbt.Common.Options
{
    ...
    public class HbtCacheOptions
    {
        ...
        /// 内存缓存配置
        /// </summary>
        public HbtMemoryCacheOptions Memory { get; set; } = new();

        /// <summary>
        /// Redis缓存配置
        /// </summary>
        public HbtRedisCacheOptions Redis { get; set; } = new();
    }

    /// <summary>
    /// 内存缓存配置选项
    /// </summary>
    public class HbtMemoryCacheOptions
    {
        /// <summary>
        /// 压缩阈值（字节）
        /// </summary>
