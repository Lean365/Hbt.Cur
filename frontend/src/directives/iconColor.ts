...
export const iconAnimation: Directive = {
  ...
  updated(el: HTMLElement, binding: DirectiveBinding) {
    // 移除之前的动画类
    el.classList.remove('hbt-icon-pulse', 'hbt-icon-spin', 'hbt-icon-bounce', 'hbt-icon-shake')
    setIconAnimation(el, binding.value)
  },
...
export const iconSize: Directive = {
  ...
  updated(el: HTMLElement, binding: DirectiveBinding) {
    // 移除之前的尺寸类
    el.classList.remove('hbt-icon-xs', 'hbt-icon-sm', 'hbt-icon-md', 'hbt-icon-lg', 'hbt-icon-xl', 'hbt-icon-xxl')
    setIconSize(el, binding.value)
  },
...
export const iconStatus: Directive = {
  ...
  updated(el: HTMLElement, binding: DirectiveBinding) {
    // 移除之前的状态类
    el.classList.remove('hbt-icon-disabled', 'hbt-icon-loading', 'hbt-icon-selected', 'hbt-icon-highlight')
    setIconStatus(el, binding.value)
  },
