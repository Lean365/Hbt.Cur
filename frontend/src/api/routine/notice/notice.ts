...
import type { HbtNoticeDto, HbtNoticeQuery, HbtNoticeCreate, HbtNoticeUpdate } from '@/types/routine/notice/notice'
 ...
 * @returns 通知列表
 */
export function getNoticeList(params: HbtNoticeQuery) {
 ...
 * @returns 创建结果
 */
export function createNotice(data: HbtNoticeCreate) {
  return request<HbtApiResponse<HbtNoticeDto>>({
    url: '/api/HbtNotice',
    method: 'post',
    data
 ...
 * @returns 更新结果
 */
export function updateNotice(id: number | bigint, data: HbtNoticeUpdate) {
  return request<HbtApiResponse<HbtNoticeDto>>({
    url: `/api/HbtNotice/${id}`,
    method: 'put',
    data
 ...
 * @returns 导出结果
 */
export function exportNoticeList(params: HbtNoticeQuery) {
  return request<Blob>({
