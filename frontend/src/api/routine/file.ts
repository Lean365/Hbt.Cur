...
import type { HbtFileDto, HbtFileQueryDto, HbtFileCreateDto, HbtFileUpdateDto } from '@/types/routine/file'
 ...
 * @returns 文件列表
 */
export function getFileList(params: HbtFileQueryDto) {
  return request<HbtApiResponse<HbtPagedResult<HbtFileDto>>>({
...
export function getFileDetail(id: number | bigint) {
  return request<HbtApiResponse<HbtFileDto>>({
    url: `/api/HbtFile/${id}`,
    method: 'get'
  })
}
 ...
 * @returns 创建结果
 */
export function createFile(data: HbtFileCreateDto) {
  return request<HbtApiResponse<HbtFileDto>>({
    url: '/api/HbtFile',
    method: 'post',
    data
 ...
 * @returns 更新结果
 */
export function updateFile(id: number | bigint, data: HbtFileUpdateDto) {
  return request<HbtApiResponse<HbtFileDto>>({
    url: `/api/HbtFile/${id}`,
    method: 'put',
    data
 ...
 * @returns 导出结果
 */
export function exportFileList(params: HbtFileQueryDto) {
  return request<Blob>({
