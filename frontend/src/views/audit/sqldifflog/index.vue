...
const tableData = ref<HbtSqlDiffLogDto[]>([])
const total = ref(0)
const queryParams = reactive<HbtSqlDiffLogQueryDto>({
  pageIndex: 1,
  pageSize: 10,
  diffType: undefined,
  tableName: undefined,
...
const currentDiff = ref<HbtSqlDiffLogDto | null>(null)
...
/** 查看详情 */
const handleViewDetail = (record: HbtSqlDiffLogDto) => {
