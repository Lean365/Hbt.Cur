  ...
  <div class="registration-container">
    ...
    <div v-if="currentStep === 0" class="step-content">
      <a-form
        ...
        layout="vertical"
      >
        <a-form-item name="captcha" :label="t('identity.auth.register.captcha')" v-if="showCaptcha">
          <HbtSliderCaptcha
    ...
    <div v-if="currentStep === 1" class="step-content">
      <a-form
        ...
        layout="vertical"
      >
        <a-form-item name="userName" :label="t('identity.auth.register.username')">
          <a-input
            v-model:value="step2Form.userName"
            :placeholder="t('identity.auth.register.usernamePlaceholder')"
            size="large"
        ...
        <a-form-item name="email" :label="t('identity.auth.register.email')">
          <a-input
            v-model:value="step2Form.email"
            :placeholder="t('identity.auth.register.emailPlaceholder')"
            size="large"
            type="email"
          >
            <template #prefix>
        ...
        <a-form-item name="password" :label="t('identity.auth.register.password')">
          <a-input-password
            v-model:value="step2Form.password"
            :placeholder="t('identity.auth.register.passwordPlaceholder')"
            size="large"
          >
            <template #prefix>
              <lock-outlined />
    ...
    <div v-if="currentStep === 2" class="step-content">
      <a-form
        ...
        layout="vertical"
      >
        <a-form-item name="nickName" :label="t('identity.auth.register.nickName')">
          <a-input
            v-model:value="step3Form.nickName"
            :placeholder="t('identity.auth.register.nickNamePlaceholder')"
            size="large"
          >
            <template #prefix>
              <user-outlined />
        ...
        <a-form-item name="realName" :label="t('identity.auth.register.realName')">
          <a-input
            v-model:value="step3Form.realName"
            :placeholder="t('identity.auth.register.realNamePlaceholder')"
            size="large"
          >
            <template #prefix>
              <user-outlined />
        ...
        <a-form-item name="fullName" :label="t('identity.auth.register.fullName')">
          <a-input
            v-model:value="step3Form.fullName"
            :placeholder="t('identity.auth.register.fullNamePlaceholder')"
            size="large"
          >
            <template #prefix>
              <user-outlined />
        ...
        <a-form-item name="englishName" :label="t('identity.auth.register.englishName')">
          <a-input
            v-model:value="step3Form.englishName"
            :placeholder="t('identity.auth.register.englishNamePlaceholder')"
            size="large"
          >
            <template #prefix>
              <user-outlined />
        ...
        <a-form-item name="phoneNumber" :label="t('identity.auth.register.phoneNumber')">
          <a-input
            v-model:value="step3Form.phoneNumber"
            :placeholder="t('identity.auth.register.phoneNumberPlaceholder')"
            size="large"
          >
            <template #prefix>
              <phone-outlined />
        ...
        <a-form-item name="gender" :label="t('identity.auth.register.gender')">
          <a-radio-group v-model:value="step3Form.gender" size="large">
            <a-radio :value="0">{{ t('identity.auth.register.genderUnknown') }}</a-radio>
            <a-radio :value="1">{{ t('identity.auth.register.genderMale') }}</a-radio>
            <a-radio :value="2">{{ t('identity.auth.register.genderFemale') }}</a-radio>
          </a-radio-group>
        </a-form-item>
        <a-form-item>
          <div style="display: flex; justify-content: space-between;">
    ...
    <div v-if="currentStep === 3" class="step-content">
      <a-form
        ...
        layout="vertical"
      >
        <a-form-item name="userType" :label="t('identity.auth.register.userType')">
          <a-select
            v-model:value="step4Form.userType"
            :placeholder="t('identity.auth.register.userTypePlaceholder')"
            size="large"
          >
            <a-select-option :value="1">{{ t('identity.auth.register.userTypeNormal') }}</a-select-option>
            <a-select-option :value="2">{{ t('identity.auth.register.userTypeAdmin') }}</a-select-option>
          </a-select>
        </a-form-item>
        <a-form-item name="status" :label="t('identity.auth.register.status')">
          <a-select
            v-model:value="step4Form.status"
            :placeholder="t('identity.auth.register.statusPlaceholder')"
            size="large"
          >
            <a-select-option :value="0">{{ t('identity.auth.register.statusNormal') }}</a-select-option>
            <a-select-option :value="1">{{ t('identity.auth.register.statusDisabled') }}</a-select-option>
          </a-select>
        </a-form-item>
...
import type { HbtUserCreate } from '@/types/identity/user'
