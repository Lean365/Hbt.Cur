    ...
    <div class="workflow-oper-detail">
      ...
      <a-descriptions :column="2" bordered>
        ...
        <a-descriptions-item :label="t('workflow.oper.fields.operType')">
          <hbt-dict-tag dict-type="workflow_oper_type" :value="detail.operType" />
        </a-descriptions-item>
...
const detail = ref<HbtInstanceOper>({
  instanceOperId: 0,
  instanceId: 0,
  nodeId: '',
  nodeName: '',
...
const fetchData = async () => {
  ...
  try {
    const response = await getInstanceOperById(props.instanceOperId)
