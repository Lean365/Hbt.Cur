<template>
  ...
  >
    ...
    <a-form-item :label="t('identity.menu.fields.icon.label')" name="icon">
      <a-input-group compact>
        <a-input
          ...
          readonly
          style="width: 70%"
          :prefix="form.icon ? hbtIconComponent(form.icon) : undefined"
        />
    ...
    <a-form-item :label="t('identity.menu.fields.tenantId.label')" name="tenantId">
      <a-input-number
        v-model:value="form.tenantId"
        :placeholder="t('identity.menu.fields.tenantId.placeholder')"
        style="width: 100%"
        :readonly="true"
        :disabled="true"
      />
...
const parentMenuPath = computed(() => {
  function findMenuById(list: any[], menuId: number | undefined): any | undefined {
...
function hbtIconComponent(name: string) {
  try {
