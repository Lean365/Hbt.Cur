...
import type { HbtDictData, HbtDictDataCreate, HbtDictDataUpdate } from '@/types/routine/core/dictData'
import { getHbtDictData, createHbtDictData, updateHbtDictData } from '@/api/routine/core/dictData'
