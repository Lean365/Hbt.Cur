...
<template>
  ...
  >
    ...
    >
      ...
      <a-form-item
        :label="t('core.dict.dictTypes.fields.tenantId.label')"
        name="tenantId"
      >
        <a-input
          v-model:value="formData.tenantId"
          :placeholder="t('core.dict.dictTypes.fields.tenantId.placeholder')"
          disabled
        />
      </a-form-item>
...
import type { HbtDictType, HbtDictTypeCreate, HbtDictTypeUpdate } from '@/types/routine/core/dictType'
import { getHbtDictType, createHbtDictType, updateHbtDictType } from '@/api/routine/core/dictType'
