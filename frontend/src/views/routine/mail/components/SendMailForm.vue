...
import type { HbtMailDto, HbtMailCreateDto } from '@/types/routine/mail.d'
import { getMailDetail, sendMail } from '@/api/routine/mail'
...
// 上传地址
const uploadUrl = import.meta.env.VITE_APP_BASE_API + '/api/HbtMail/upload'
...
const handleSubmit = async () => {
  try {
    ...
    const submitData: HbtMailCreateDto = {
      ...formData.value,
