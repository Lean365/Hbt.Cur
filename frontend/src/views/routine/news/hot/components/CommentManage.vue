...
import type { HbtNewsComment } from '@/types/routine/news/comment'
import { 
  getCommentsByNewsId, 
  approveNewsComment, 
  rejectNewsComment 
...
const commentList = ref<HbtNewsComment[]>([])
...
// 通过评论
const handleApprove = async (record: HbtNewsComment) => {
  try {
...
// 拒绝评论
const handleReject = async (record: HbtNewsComment) => {
  try {
...
// 查看详情
const handleViewDetail = (record: HbtNewsComment) => {
  // 实现查看详情逻辑
