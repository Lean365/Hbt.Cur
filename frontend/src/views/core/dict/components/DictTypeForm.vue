...
import type { HbtDictType, HbtDictTypeCreate, HbtDictTypeUpdate } from '@/types/core/dictType'
import { getHbtDictType, createHbtDictType, updateHbtDictType } from '@/api/core/dictType'
