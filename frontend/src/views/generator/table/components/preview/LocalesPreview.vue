<template>
  <div class="preview-container">
    <div class="preview-header">
      <h3>{{ t('generator.table.preview.locales.title') }}</h3>
    ...
    <div class="preview-content" ref="previewContent">
      <pre v-highlightjs="formattedCode" :class="['language-typescript', { 'line-numbers': showLineNumbers }]">
        <code></code>
      </pre>
    </div>
  </div>
