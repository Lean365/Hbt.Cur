<template>
  <div class="preview-container">
    <div class="preview-header">
      <h3>{{ t('generator.table.preview.vue.title') }}</h3>
    ...
    <div class="preview-content" ref="previewContent">
      <pre v-highlightjs="formattedCode" :class="['language-vue', { 'line-numbers': showLineNumbers }]">
        <code></code>
      </pre>
    </div>
  </div>
...
import 'highlight.js/lib/languages/vue'
