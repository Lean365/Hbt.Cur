...
import type { HbtGenTableDefine, HbtGenTableDefineCreate, HbtGenTableDefineUpdate } from '@/types/generator/genTableDefine'
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (res.data.code === 200) {
      ...
      message.error(res.data.msg || (props.tableId ? '更新失败' : '创建失败'))
    }
  } catch (error: any) {
